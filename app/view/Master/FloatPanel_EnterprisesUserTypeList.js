Ext.define('BuskartApp.view.Master.FloatPanel_EnterprisesUserTypeList', {

});

var _FloatPanel_EnterprisesUserTypeList;


var isFloatPanel_EnterprisesUserTypeListOpen = 'N';
...
function FloatPanel_EnterprisesUserTypeList() {

    _FloatPanel_EnterprisesUserTypeList =
     Ext.create('Ext.Panel', {

         xtype: 'container',
         height: 350,
         width: '95%',
         id: 'LoadingFloatPanel_EnterprisesUserTypeListID',
         draggable: false,
             ...
             initialize: function (c) {
                 this.element.on({
                     swipe: function (e, node, options) {
                         ...
                         if (e.direction == "left") {
                             _FloatPanel_EnterprisesUserTypeList.hide(Ext.fx.Animation({
                                 type: 'slideOut',
                                 direction: 'left',
                                 easing: 'cubic-bezier(.7,0,.7,1)',
                                 duration: 250
                         ...
                         isFloatPanel_EnterprisesUserTypeListOpen = 'N';
                     }
                 });
             }
         },
         ...
         items: {
             ...
             items: [
...

                 {
                     ...
                     id: 'containerFloatPanel_EnterprisesUserTypeListHeader',
                     //style: {
                     //    // background: '#D25959',
                     ...
                     items:
                            [
                                          ...
                                          {
                                              xtype: 'button',
                                              id: 'btnFloatPanel_EnterprisesUserTypeListBack',
                                              height: 30,
                                              width: 35,
                                              // iconCls: 'list',
                                          ...
                                          {
                                              margin: '0 0 0 0',
                                              html: '<font size=2 color=white><b>User Type</b></font>'
                                          },
                                           {
                                               xtype: 'spacer',
...

            {
                ...
                xtype: 'container',
                margin: '10 0 0 0',
                id: 'FloatPanel_EnterprisesUserTypeListBorderBg',
                ...
                items: [
...

                    {
                        xtype: 'list',
                        //  flex: 1,
                        store: 'AyohaEnterprisesUserTypeLoadStore',
                        id: 'FloatPanel_EnterprisesTypeStoreID',
                        mode: 'SINGLE',
                        ...
                        itemTpl: '<div class="myContent">' +
                            ...
                            '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:18px;font-weight:normal;float:left;width:77.5%;"><b>{UserType}</b></div>' +
                     ...
                     // '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:67.5%;"><b>{ReceiptName}</b><br><font size=1>Upload Date:{CreatedDate}</font></div><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:17%"><b>{Amount}</b></div></div><div style="float:right;width:5%;margin:-45px 35px 0px 0px"><button class="buttonssDelete button14" OnClick="DeleteReceiptImageFromList({ID})"><img src="resources/icons/UogradeAutismeIcon/deletedustbin.png" height="30" width="30"></button></div><div style="float:right;width:5%;margin:-45px 0px 0px 0px"><button class="buttonssDelete button14" OnClick="MovementClaimReceiptImageParkingShowEdit({ID});"><img src="resources/icons/editresititem.png" height="30" width="30"></button></div>' +
                        ...
                        listeners: {
                            ...
                            itemdoubletap: function (dataview, index, target, record, e, eOpts) {
                                ...
                                if (isFloatPanel_EnterprisesUserTypeListOpen == 'Y') {
                                ...
                                if (isFloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsOpen == 'Y') {
                                    document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsUserType').value = UserType;
                                    ...
                                    document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseUserType').value = UserType;
                                }
    ...
    return _FloatPanel_EnterprisesUserTypeList;
...
function FloatPanel_EnterprisesUserTypeListShow() {

    Ext.Viewport.remove(_FloatPanel_EnterprisesUserTypeList);
    this.overlay = Ext.Viewport.add(FloatPanel_EnterprisesUserTypeList());
    this.overlay.show();
    isFloatPanel_EnterprisesUserTypeListOpen = 'Y';
}


function FloatPanel_EnterprisesUserTypeListHide() {
    _FloatPanel_EnterprisesUserTypeList.hide(); isFloatPanel_EnterprisesUserTypeListOpen = 'N';
}
