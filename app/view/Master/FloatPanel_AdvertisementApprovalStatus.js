Ext.define('BuskartApp.view.Master.FloatPanel_AdvertisementApprovalStatus', {

});

var _FloatPanel_AdvertisementApprovalStatus;


var isFloatPanel_AdvertisementApprovalStatusOpen = 'N';
...
function FloatPanel_AdvertisementApprovalStatus() {

    _FloatPanel_AdvertisementApprovalStatus =
     Ext.create('Ext.Panel', {

         xtype: 'container',
         height: 350,
         width: '95%',
         id: 'LoadingFloatPanel_AdvertisementApprovalStatusID',
         draggable: false,
             ...
             initialize: function (c) {
                 this.element.on({
                     swipe: function (e, node, options) {
                         ...
                         if (e.direction == "left") {
                             _FloatPanel_AdvertisementApprovalStatus.hide(Ext.fx.Animation({
                                 type: 'slideOut',
                                 direction: 'left',
                                 easing: 'cubic-bezier(.7,0,.7,1)',
                                 duration: 250
                         ...
                         isFloatPanel_AdvertisementApprovalStatusOpen = 'N';
                         RemovePages("FloatPanel_AdvertisementApprovalStatusHide()");
                     }
                 });
             }
         },
         ...
         items: {
             ...
             items: [
...

                 {
                     ...
                     id: 'containerFloatPanel_AdvertisementApprovalStatusHeader',
                     //style: {
                     //    // background: '#D25959',
                     ...
                     items:
                            [
                                          ...
                                          {
                                              xtype: 'button',
                                              id: 'btnFloatPanel_AdvertisementApprovalStatusBack',
                                              height: 30,
                                              width: 35,
                                              // iconCls: 'list',
                                          ...
                                          {
                                              margin: '0 0 0 0',
                                              html: '<font size=2 color=white><b>Approval Status</b></font>'
                                          },
                                           {
                                               xtype: 'spacer',
...

            {
                ...
                xtype: 'container',
                margin: '10 0 0 0',
                id: 'FloatPanel_AdvertisementApprovalStatusBorderBg',
                ...
                items: [
...

                    {
                        xtype: 'list',
                        //  flex: 1,
                        store: 'AdvertisementApprovalStatusLoadMasterStore',
                        id: 'FloatPanel_AdvertisementApprovalStatusLoadMasterListID',
                        mode: 'SINGLE',
                        ...
                        itemTpl: '<div class="myContent">' +
                            ...
                            '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:18px;font-weight:normal;float:left;width:77.5%;"><b>{AdvertisementStatus}</b></div>' +
                     ...
                     // '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:67.5%;"><b>{ReceiptName}</b><br><font size=1>Upload Date:{CreatedDate}</font></div><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:17%"><b>{Amount}</b></div></div><div style="float:right;width:5%;margin:-45px 35px 0px 0px"><button class="buttonssDelete button14" OnClick="DeleteReceiptImageFromList({ID})"><img src="resources/icons/UogradeAutismeIcon/deletedustbin.png" height="30" width="30"></button></div><div style="float:right;width:5%;margin:-45px 0px 0px 0px"><button class="buttonssDelete button14" OnClick="MovementClaimReceiptImageParkingShowEdit({ID});"><img src="resources/icons/editresititem.png" height="30" width="30"></button></div>' +
                        ...
                        listeners: {
                            ...
                            itemdoubletap: function (dataview, index, target, record, e, eOpts) {
                                var AdvertisementStatus = record.get('AdvertisementStatus');
                                document.getElementById('input-FloatPanel_AdvertisementSetting_Status').value = AdvertisementStatus;
                                if (isFloatPanel_AdvertisementApprovalStatusOpen == 'Y') {
                                    _FloatPanel_AdvertisementApprovalStatus.hide(Ext.fx.Animation({
                                        //type: 'popOut',
                                        //easing: 'easeInOut',
                                        //duration: 250,
    ...
    return _FloatPanel_AdvertisementApprovalStatus;
...
function FloatPanel_AdvertisementApprovalStatusShow() {

    Ext.Viewport.remove(_FloatPanel_AdvertisementApprovalStatus);
    this.overlay = Ext.Viewport.add(FloatPanel_AdvertisementApprovalStatus());
    this.overlay.show();
    AddRoutePages("FloatPanel_AdvertisementApprovalStatusHide()");
    isFloatPanel_AdvertisementApprovalStatusOpen = 'Y';
}


function FloatPanel_AdvertisementApprovalStatusHide() {
    if (isFloatPanel_AdvertisementApprovalStatusOpen == "Y") {
        _FloatPanel_AdvertisementApprovalStatus.hide(); isFloatPanel_AdvertisementApprovalStatusOpen = 'N';
        RemovePages("FloatPanel_AdvertisementApprovalStatusHide()");
    }
