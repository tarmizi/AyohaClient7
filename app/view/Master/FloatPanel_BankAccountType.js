Ext.define('BuskartApp.view.Master.FloatPanel_BankAccountType', {

});

var _FloatPanel_BankAccountType;


var isFloatPanel_BankAccountTypeOpen = 'N';
...
function FloatPanel_BankAccountType() {

    _FloatPanel_BankAccountType =
     Ext.create('Ext.Panel', {

         xtype: 'container',
         height: 350,
         width: '95%',
         id: 'LoadingFloatPanel_BankAccountTypeID',
         draggable: false,
             ...
             initialize: function (c) {
                 this.element.on({
                     swipe: function (e, node, options) {
                         ...
                         if (e.direction == "left") {
                             _FloatPanel_BankAccountType.hide(Ext.fx.Animation({
                                 type: 'slideOut',
                                 direction: 'left',
                                 easing: 'cubic-bezier(.7,0,.7,1)',
                                 duration: 250
                         ...
                         isFloatPanel_BankAccountTypeOpen = 'N';
                     }
                 });
             }
         },
         ...
         items: {
             ...
             items: [
...

                 {
                     ...
                     id: 'containerFloatPanel_BankAccountTypeHeader',
                     //style: {
                     //    // background: '#D25959',
                     ...
                     items:
                            [
                                          ...
                                          {
                                              xtype: 'button',
                                              id: 'btnFloatPanel_BankAccountTypeBack',
                                              height: 30,
                                              width: 35,
                                              // iconCls: 'list',
...

                                           {
                                             ...
                                             {
                                                 margin: '0 0 0 0',
                                                 html: '<font size=2 color=white><b>Bank Account Type</b></font>'
                                             },
...

            {
                ...
                xtype: 'container',
                margin: '10 0 0 0',
                id: 'FloatPanel_BankAccountTypeBorderBg',
                ...
                items: [
...

                    {
                        xtype: 'list',
                        //  flex: 1,
                        store: 'BankAccountTypeStore',
                        id: 'FloatPanel_BankAccountTypeLoadMasterListID',
                        mode: 'SINGLE',
                        ...
                        itemTpl: '<div class="myContent">' +
                            ...
                            '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:18px;font-weight:normal;float:left;width:77.5%;"><b>{BankAccountType}</b></div>' +
                     ...
                     // '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:67.5%;"><b>{ReceiptName}</b><br><font size=1>Upload Date:{CreatedDate}</font></div><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:17%"><b>{Amount}</b></div></div><div style="float:right;width:5%;margin:-45px 35px 0px 0px"><button class="buttonssDelete button14" OnClick="DeleteReceiptImageFromList({ID})"><img src="resources/icons/UogradeAutismeIcon/deletedustbin.png" height="30" width="30"></button></div><div style="float:right;width:5%;margin:-45px 0px 0px 0px"><button class="buttonssDelete button14" OnClick="MovementClaimReceiptImageParkingShowEdit({ID});"><img src="resources/icons/editresititem.png" height="30" width="30"></button></div>' +
                        ...
                        listeners: {
                            ...
                            itemdoubletap: function (dataview, index, target, record, e, eOpts) {
                                var BankAccountType = record.get('BankAccountType');
                                document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_EnterpriseDetails_BankInfoAccountType').value = BankAccountType;
                                if (isFloatPanel_BankAccountTypeOpen == 'Y') {
                                    _FloatPanel_BankAccountType.hide(Ext.fx.Animation({
                                        //type: 'popOut',
                                        //easing: 'easeInOut',
                                        //duration: 250,
    ...
    return _FloatPanel_BankAccountType;
...
function FloatPanel_BankAccountTypeShow() {

    Ext.Viewport.remove(_FloatPanel_BankAccountType);
    this.overlay = Ext.Viewport.add(FloatPanel_BankAccountType());
    this.overlay.show();
    isFloatPanel_BankAccountTypeOpen = 'Y';
}


function FloatPanel_BankAccountTypeHide() {
    _FloatPanel_BankAccountType.hide(); isFloatPanel_BankAccountTypeOpen = 'N';
}
