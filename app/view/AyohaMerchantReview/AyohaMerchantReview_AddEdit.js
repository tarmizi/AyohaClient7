...
var starCount = 0;
var _AyohaMerchantReview_AddEdit=null;
...
function FloatPanel_AyohaMerchantReview_AddEditCreateIfNeeded() {

    if (_AyohaMerchantReview_AddEdit && !_AyohaMerchantReview_AddEdit.destroyed) return;
    ...
    //     cls: 'ayohaCheckinModal',
       ...
       // style:ayohaThemeColor_Background(),
        ...
        items: {
            ...
            height: 485,
            xtype: 'container',
            style:ayohaThemeColor_Body_ThemeColor_Border(),
...
function AyohaMerchantReview_AddEditHide(fromBack, animCfg) {
    ...
    if (isAyohaMerchantReview_AddEditOpen == "Y") {
        ...
        if (animCfg) {
            _AyohaMerchantReview_AddEdit.hide(Ext.fx.Animation(animCfg));
          } else {
            _AyohaMerchantReview_AddEdit.hide();
          }
         ...
         // RemovePages("FloatPanel_ForgotPasswordHide()");
          ...
          if (fromBack !== true) {
            AyohaBrowserBack.close('AyohaMerchantReview_AddEdit');
          }
    }
