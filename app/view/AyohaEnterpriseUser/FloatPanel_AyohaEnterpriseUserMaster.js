...
Ext.define('BuskartApp.view.AyohaEnterpriseUser.FloatPanel_AyohaEnterpriseUserMaster', {

});

var _FloatPanel_AyohaEnterpriseUserMaster;


var isFloatPanel_AyohaEnterpriseUserMasterOpen = 'N';
...
function FloatPanel_AyohaEnterpriseUserMaster() {

    _FloatPanel_AyohaEnterpriseUserMaster =
    Ext.create('Ext.Panel', {
        ...
        height: '100%',
        width: '100%',
        id: 'FloatPanel_AyohaEnterpriseUserMasterID',
        draggable: false,
            ...
            initialize: function (c) {
                this.element.on({
                    swipe: function (e, node, options) {
                        ...
                        //}
                        if (e.direction == "left") {
                            _FloatPanel_AyohaEnterpriseUserMaster.hide(Ext.fx.Animation({
                                type: 'slideOut',
                                direction: 'left',
                                easing: 'cubic-bezier(.7,0,.7,1)',
                                duration: 250
        ...
        items: [
...

            {
                        ...
                        items: [
                            {
                                ...
                                id: 'containerFloatPanel_AyohaEnterpriseUserMasterHeader',
                                style: {
                                    // background: '#D25959',
                                ...
                                items:
                                       [
                                                     ...
                                                     {
                                                         xtype: 'button',
                                                         id: 'btnFloatPanel_AyohaEnterpriseUserMasterBack',
                                                         height: 30,
                                                         width: 35,
                                                         // iconCls: 'list',
                                                     ...
                                                     {
                                                         margin: '0 0 0 0',
                                                         id: 'htmlFloatPanel_AyohaEnterpriseUserMaster_TitleHeaderTxt',
...

                                                      {
                                                          ...
                                                          html: '<font size=3 color=white><b>TARMIZI RAHIM</b></font>'
...

                                                              {
                                                                  ...
                                                                  width: 70,
                                                                  // margin: '70 0 0 0',
                                                                  id: 'containerFloatPanel_AyohaEnterpriseUserMasterHaiUser',
                                                                  layout: {
                                                                  ...
                                                                  items: [
                                                                      ...
                                                                      {
                                                                          margin: '0 0 0 0',
                                                                          id: 'htmlFloatPanel_AyohaEnterpriseUserMasterHaiUser',
                                                                      ...
                                                                      },
                                                                      {
                                                                          ...
                                                                          width: 70,
                                                                          // margin: '70 0 0 0',
                                                                          id: 'containerFloatPanel_AyohaEnterpriseUserMastereWallet',
                                                                          layout: {
                                                                          ...
                                                                          items: [
                                                                               {
                                                                                   xtype: 'button',
                                                                                   id: 'btnFloatPanel_AyohaEnterpriseUserMastereWallet',
                                                                                   margin: '4 0 0 -15',
                                                                                   height: 30,
                                                                                   width: 35,
                                                                                   // iconCls: 'list',
                                                              ...
                                                              },
                                                           {
                                                               ...
                                                               width: 40,
                                                               // margin: '70 0 0 0',
                                                               id: 'containerFloatPanel_AyohaEnterpriseUserMasterPictureUser',
                                                               layout: {
                                                               ...
                                                               items: [
                                                                   {
                                                                       ...
                                                                       width: 40,
                                                                       margin: '0 0 0 -11',
                                                                       id: 'btnFloatPanel_AyohaEnterpriseUserMasterInfo',
                                                                       //badgeText: "2",
...

                              {
                                  ...
                                  // hidden: true,
                                  //  hidden:true,
                                  id: 'tabpanelFloatPanel_AyohaEnterpriseUserMaster',
              ...
              {
                  xtype: 'container',
                  id: 'containerFloatPanel_AyohaEnterpriseUserMaster_EnterpriseInformation',
                  width: '100%',
                  // height: 360,
                  height:'100%',
                  ...
                  title: 'FloatPanel_AyohaEnterpriseUserMasterMaster',
                  layout: {
                      type: 'vbox',
                      pack: 'start',
                      align: 'center'
                          ...
                          this.element.on({
                              swipe: function (e, node, options) {
                                  if (e.direction == "left") {
                                      ...
                                      Ext.getCmp('tabpanelFloatPanel_AyohaEnterpriseUserMaster').setActiveItem(1);
                                  } else {
...

                      {
                          ...
                          items: [

                               {
                                   ...
                                   height: 130,
                                   width: 130,
                                   id:'FloatPanel_AyohaEnterpriseUserMaster_EnterpriseLogo',
    ...
    items: [
         {
             ...
             html: '<font size=2 color=white>Logo</font>',
...

         {
             ...
             width: '80%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterpriseLogo"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         },
        {
         ...
         {
             id:'FloatPanel_AyohaEnterpriseUserMaster_EnterpriseName',
             margin: '-2 0 0 0',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterpriseName"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_Address',
             margin: '-2 0 0 0',
             width: '90%',
             height: 50,
             html: '<input type="textarea" id="input-FloatPanel_AyohaEnterpriseUserMaster_Address"  style="border-color:white;color:white;width:100%;height:35px;text-align: left;font-size:12px;">'
...

         {
             ...
             html: '<font size=2 color=white>Registration No.</font>',

         },

         {
            
             id: 'FloatPanel_AyohaEnterpriseUserMaster_EnterpriseRegistrationNo',
             margin: '-2 0 0 0',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterpriseRegistrationNo"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
...

         {
             ...
             id: 'FloatPanel_AyohaEnterpriseUserMaster_EnterpriseEmail',
             margin: '-2 0 0 0',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterpriseEmail"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_EnterprisePhoneNo',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterprisePhoneNo"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
...

         {
             ...
             html: '<font size=2 color=white>CreatedDate</font>',

         },

         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_EnterpriseCreatedDate',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterpriseCreatedDate"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_EnterpriseDescriptions',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterpriseDescriptions"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_EnterpriseFacebook',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterpriseFacebook"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_EnterpriseTwitter',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterpriseTwitter"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_EnterpriseInstagram',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterpriseInstagram"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_EnterpriseWebsite',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterpriseWebsite"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'

         },
            {
                margin: '3 0 0 0',

                html: '<font size=2 color=white>Location Coordinate</font>',

            },

         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_EnterpriseCoordinate',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_EnterpriseCoordinate"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_LoyaltyCardType',
             width: '90%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_LoyaltyCardType"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
...
{
    xtype: 'button',
    id: 'btn_FloatPanel_AyohaEnterpriseUserMaster_Save',
    //  badgeText: '1',
    margin: '0 0 0 0',
    height: 40,
    width: 40,
    ...
    handler: function () {
              ...
              {
                  xtype: 'container',
                  id: 'containerFloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseInformation',
                  width: '100%',
                  height: '100%',
                  //style: "background-color: white;border-right:2px solid #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px #ECF0F1 white;border-radius: 50px 50px 50px 50px;",
                  style: "background-color: transparent;",
    ...
    items: [
         {
             ...
             html: '<font size=2 color=white>User Profile Picture</font>',
...

         {
             ...
             id: 'FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseLogo',
             width: '80%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_UserEnterprisePhoto"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         },
        {
         ...
         {
             id:'FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseAccountName',
             margin: '-2 0 0 0',
             width: '80%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseAccountName"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             //margin: '-2 0 0 0',
             //id: 'FloatPanel_AyohaEnterpriseUserMaster_UserEnterprisePhoneNumber',
             //margin: '-2 0 0 0',
             //width: '80%',
             //height: 20,
             //html: '<input type="textarea" id="input-FloatPanel_AyohaEnterpriseUserMaster_UserEnterprisePhoneNumber"  style="border-color:white;color:white;width:100%;height:35px;text-align: left;font-size:12px;">'
             ...
             width: '80%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_UserEnterprisePhoneNumber"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
...

         {
             ...
             id: 'FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseEmail',
             margin: '-2 0 0 0',
             width: '80%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseEmail"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
...

         {
             ...
             html: '<font size=2 color=white>MyKad No</font>',

         },

         {
           
             id: 'FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseMyKadNo',
             margin: '-2 0 0 0',
             width: '80%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseMyKadNo"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseRegisterDate',
             width: '80%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseRegisterDate"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
...

         {
             ...
             html: '<font size=2 color=white>Ayoha User ID</font>',

         },

         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseAyohaEnterpriseUserID',
             width: '80%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseAyohaEnterpriseUserID"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseLastLoginDate',
             width: '80%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseLastLoginDate"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseUserName',
             width: '80%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseUserName"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
         ...
         {
             margin: '-2 0 0 0',
             id: 'FloatPanel_AyohaEnterpriseUserMaster_UserEnterprisePassword',
             width: '80%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseUserMaster_UserEnterprisePassword"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
...
{
    xtype: 'button',
    id: 'btn_FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseSave',
    //  badgeText: '1',
    margin: '0 0 0 0',
    height: 40,
    width: 40,
    ...
    handler: function () {
              ...
              //      },
                                       ...
                                       {
                                           xtype: 'container',
                                           id: 'containerFloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseStampPointTransactionLog',
                                           width: '100%',
                                           height: '100%',
                                           //style: "background-color: white;border-right:2px solid #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px #ECF0F1 white;border-radius: 50px 50px 50px 50px;",
                                           style: "background-color: transparent;",
                                           //style: "background-color: #F35B57;",
                                           title: 'FloatPanel_AyohaEnterpriseUserMaster_UserEnterpriseStampPointTransactionLog',
                                           layout: {
                                               type: 'vbox',
                                               pack: 'center',
                                               align: 'center'
                                           ...
                                           //                } else {
                                           //                    //  alert("Hey! I swipe right");
                                           //                    Ext.getCmp('tabpanelFloatPanel_AyohaEnterpriseUserMaster').setActiveItem(0);
                                           //                }
                                           //            }
                                           //        });
                                           //    }
                              ...
                              {
                                  xtype: 'container',
                                  id: 'containerFloatPanel_AyohaEnterpriseUserMasterTitleOutter',
                                  width: '100%',
                                  docked: 'bottom',
                                  //height: 45,
                                  ...
                                  items: [
                                      {
                                          xtype: 'container',
                                          id: 'containerFloatPanel_AyohaEnterpriseUserMasterTitleCustomerInfo',
                                          flex: 1,
                                          //width: '33.3%',
                                          //height: 45,
                                          style: "background-color: transparent",
                                          ...
                                          items: [
                                               ...
                                               {
                                                   xtype: 'button',
                                                   id: 'btnCustomerInfo_FloatPanel_AyohaEnterpriseUserMaster',
                                                   //  badgeText: '1',
                                                   margin: '0 0 0 0',
                                                   height: 40,
                                                   width: 40,
                                                   html: '<img src="resources/icons/CustomerInfoOne.png" width="30" height="30" alt="Company Name">',
                                                   ui: 'plain',
                                                   handler: function () {
                                                       // NotificationsPanelShow();
                                                       // LoyaltyCardRedeemListShow();
                                                       Ext.getCmp('tabpanelFloatPanel_AyohaEnterpriseUserMaster').setActiveItem(0);
                                                       //Ext.getCmp('htmlFloatPanel_AyohaEnterpriseUserMaster_TitleHeaderTxt').setHtml('<font size=2 color=white><b>Customer Info</b></font>');
                                               ...
                                               },
                                                {
                                                    ...
                                                    html: '<font size=1 color=grey><b>Enterprise Information</b></font>'
                                                },
                                          ...
                                          {
                                              xtype: 'container',
                                              id: 'containerFloatPanel_AyohaEnterpriseUserMasterStampCardHistory',
                                              //width: '33.3%',
                                              //height: 45,
                                              flex: 1,
                                              style: "background-color: transparent",
                                              ...
                                              items: [
                                                   ...
                                                   {
                                                       xtype: 'button',
                                                       id: 'btnStampCardHistory_FloatPanel_AyohaEnterpriseUserMaster',
                                                       //  badgeText: '1',
                                                       margin: '0 0 0 0',
                                                       height: 40,
                                                       width: 40,
                                                       html: '<img src="resources/icons/StampTiltLeftOne.png" width="30" height="30" alt="Company Name">',
                                                       ui: 'plain',
                                                       handler: function () {

                                                           Ext.getCmp('tabpanelFloatPanel_AyohaEnterpriseUserMaster').setActiveItem(1);
                                                           // NotificationsPanelShow();
                                                           //Load_FloatPanel_AyohaEnterpriseUserMaster_LoyaltyStampLoadBySubscriberAccNoAndEnterpriseAccNoHistoryStore();
                                                           //Ext.getCmp('tabpanelFloatPanel_AyohaEnterpriseUserMaster').setActiveItem(1);
                                                           //Ext.getCmp('htmlFloatPanel_AyohaEnterpriseUserMaster_TitleHeaderTxt').setHtml('<font size=2 color=white><b>Stamp Card History</b></font>');
                                          ...
                                          },
                                          {
                                              xtype: 'container',
                                              hidden:true,
                                              id: 'containerFloatPanel_AyohaEnterpriseUserMasterStampPointHistory',
                                              //width: '33.3%',
                                              //height: 45,
                                              flex: 1,
                                              style: "background-color: transparent",
                                              ...
                                              items: [
                                                   ...
                                                   {
                                                       xtype: 'button',
                                                       id: 'btnStampPointHistory_FloatPanel_AyohaEnterpriseUserMaster',
                                                       //  badgeText: '1',
                                                       margin: '0 0 0 0',
                                                       height: 40,
                                                       width: 40,
                                                       ...
                                                       handler: function () {
                                                           // NotificationsPanelShow();
                                                           //Ext.getCmp('tabpanelFloatPanel_AyohaEnterpriseUserMaster').setActiveItem(2);
                                                           //Ext.getCmp('htmlFloatPanel_AyohaEnterpriseUserMaster_TitleHeaderTxt').setHtml('<font size=2 color=white><b>Points History</b></font>');
                                                           //Ext.getCmp('htmlRedeemHistoryTxt').setHtml('<font size=1 color=grey><b>Redeem History</b></font>');
                                                           //Ext.getCmp('htmlStampHistoryTxt').setHtml('<font size=1 color=grey><b>Stamp History</b></font>');
                                          ...
                                          {
                                              xtype: 'container',
                                              id: 'containerFloatPanel_AyohaEnterpriseUserMasterTitleRedeemHistory',
                                              hidden: true,
                                              //width: '33.3%',
                                              //height: 45,
                                              flex: 1,
                                              ...
                                              items: [
                                                   ...
                                                   {
                                                       xtype: 'button',
                                                       id: 'btnRedeemHistory_FloatPanel_AyohaEnterpriseUserMasterBottom',
                                                       //  badgeText: '1',
                                                       margin: '0 0 0 0',
                                                       height: 40,
                                                       width: 40,
    ...
    return _FloatPanel_AyohaEnterpriseUserMaster;
...
function FloatPanel_AyohaEnterpriseUserMasterShow() {

    Ext.Viewport.remove(_FloatPanel_AyohaEnterpriseUserMaster);
    this.overlay = Ext.Viewport.add(FloatPanel_AyohaEnterpriseUserMaster());
    this.overlay.show();
    isFloatPanel_AyohaEnterpriseUserMasterOpen = 'Y';


    Ext.getCmp('tabpanelFloatPanel_AyohaEnterpriseUserMaster').getTabBar().hide();
    //Ext.getCmp('htmlRedeemHistoryTxt').setHtml('<font size=1 color=grey><b>Redeem History</b></font>');
    //Ext.getCmp('htmlStampHistoryTxt').setHtml('<font size=1 color=grey><b>Stamp History</b></font>');
    //Ext.getCmp('htmlPointHistoryTxt').setHtml('<font size=1 color=grey><b>Point History</b></font>');
    //Ext.getCmp('htmlCustomerInfoTxt').setHtml('<font size=1 color=purple><b><u>Customer Info</u></b></font>');
...
function FloatPanel_AyohaEnterpriseUserMasterHide() {
    _FloatPanel_AyohaEnterpriseUserMaster.hide(); isFloatPanel_AyohaEnterpriseUserMasterOpen = 'N';
}



var StampCount;
function Load_FloatPanel_AyohaEnterpriseUserMaster_LoyaltyStampLoadBySubscriberAccNoAndEnterpriseAccNoHistoryStore() {
