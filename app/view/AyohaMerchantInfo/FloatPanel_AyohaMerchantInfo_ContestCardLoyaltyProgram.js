...
Ext.define('BuskartApp.view.AyohaMerchantInfo.FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgram', {
       ...
       // style: ' background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9);',
        ...
        items: [
           ...
           
            {
                ...
                width: '100%',
                height: '100%',
                id: 'FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgramListContentID',
                layout: {
                    type: 'vbox',
                    pack: 'start',
                    align: 'center'
                ...
                items: [
                  ...
                  //         '<tr>' +
                  //         // Stamp 1
                  //         '<td style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:5px 7px;border-style:none;overflow:hidden;word-break:normal;width:33.33%;vertical-align:top;text-align:center;" onclick="FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgram_OpenMerchantLoyaltyProgram({ID1})">{ModifiedStampContent1}</td>' +
                  //         // Stamp 2
...
function FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgramShow() {
  ...
  //  FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgramAdjustHeight();
    //FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgramList_AyohaUserStampCardNearestRedeemItemStore();
    FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgram_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore();
    document.getElementById("input-FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgram_SearchTxt").addEventListener("keyup", MerchantLoyaltyCampaign_LoadContestStoreStoreOnKeyUp);
...
var countMerchantLoyaltyCampaign_LoadContestCardStoreFirst=0;
function MerchantLoyaltyCampaign_LoadContestStoreStoreOnKeyUp(){
        ...
        var countMerchantLoyaltyCampaign_LoadContestStore = 0;
    
    
        _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.clearFilter();
    
        var queryString = document.getElementById('input-FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgram_SearchTxt').value;
        ...
        if (queryString) {
            ...
            _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.filterBy(function (record) {
...
function FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgram_MembershipCardCode(val){
    globalsetMessage_toBeAyohaMember_tag="MerchantLoyaltyCampaign";

    

    var EnterpriseAccNo = _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.findRecord('MembershipCardCode', val, 0, false, false, true);
    var ContestCode = _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.findRecord('MembershipCardCode', val, 0, false, false, true);
    var MembershipCardCode = _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.findRecord('MembershipCardCode', val, 0, false, false, true);
    var CountStar = _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.findRecord('MembershipCardCode', val, 0, false, false, true);
    var CountReviewer = _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.findRecord('MembershipCardCode', val, 0, false, false, true);
    var MembershipCardFeePaymentCycle = _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.findRecord('MembershipCardCode', val, 0, false, false, true);



    var EnterpriseAccNos= EnterpriseAccNo.get('EnterpriseAccNo');
    var ContestCodes= ContestCode.get('ContestCode');
    ...
    globalLatestPointCampaignCode = ContestCodes;    
...
function FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgram_OpenContestCard(val){
    globalsetMessage_toBeAyohaMember_tag="MerchantLoyaltyCampaign";
    ...
    var MembershipCardCode = _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.findRecord('ContestCode', val, 0, false, false, true);
    var CountStar = _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.findRecord('ContestCode', val, 0, false, false, true);
    var CountReviewer = _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.findRecord('ContestCode', val, 0, false, false, true);
...
function FloatPanel_AyohaMerchantInfo_ContestCardLoyaltyProgram_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore() {
    ...
    _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.getProxy().setExtraParam('SubscriberAccNo', GetCurrAyohaUserAccountNo());
    _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.getProxy().setUrl(GetAPIurl() + '/MerchantLoyaltyCampaign/MerchantLoyaltyCampaign_LoadContest');
 

    _DataStore_MerchantLoyaltyCampaign_LoadContestCardLoyaltyStore.load({
