...
var _FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram=null;
...
function FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgramCreateIfNeeded() {
    if (_FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram && !_FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram.destroyed) return;
                ...
                items:
                       [
...

                                     {
                                      ...
                                      {
                                       html:ayohaTheme_HeaderText('Membership Discount'),
                                        margin: '0 15 0 0',   
...

{
    ...
    emptyText: '<div style="background-color:transparent;width:100%;height:100%;">No Membership Discount at This Moment!</div>',

    itemTpl: new Ext.XTemplate([
        '<div onclick="FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram_OpenDiscountCard(`{MembershipCardCode}`)" ',
        'style="background:#fff;width:100%;box-sizing:border-box;border-radius:12px;overflow:hidden;margin:0 0 16px 0;border:0;box-shadow:0 12px 30px rgba(24,39,75,.14), 0 3px 10px rgba(24,39,75,.10);">',

            '<div style="position:relative;">',
                '<img src="{DiscountImgPath}" alt="{DiscountName}" style="width:100%;height:auto;display:block;">',

                '<div style="position:absolute;bottom:-25px;right:20px;display:flex;flex-direction:column;align-items:center;justify-content:center;',
                'width:60px;height:60px;background:#9b59b6;color:#fff;border-radius:50%;',
                'box-shadow:0 4px 8px rgba(0,0,0,0.2);border:2px solid #fff;font-weight:bold;line-height:1;gap:2px;z-index:10;">',
                    '<span style="font-size:14px;margin:0;">{ModifiedDiscountPercent}%</span>',
                    '<span style="font-size:8px;margin:0;">Discount</span>',
                '</div>',
            '</div>',
            ...
            '<div style="padding:16px;margin-top:10px;">',
                ...
                '<h2 style="font-size:20px;font-weight:700;margin:16px 0 4px 0;color:#2c3e50;line-height:1.4;">{DiscountNote}</h2>',

                '<p style="margin:0 0 16px 0;color:#95a5a6;font-size:12px;">End Date: {DiscountEndDate}</p>',
                                ...
                                items:[
                                    {
                                       // height: ayohaThemeColor_Bottom_SearchBox_Height(),
                                        ...
                                        '<div class="ayohaSearchBar">' +
                                          ...
                                          '<input  id="input-FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram_SearchTxt" class="ayohaSearchInput" type="search" ' +
...
function FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgramShow() {
   ...
   FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgramCreateIfNeeded();


    _FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram.show();
   // ✅ push browser back (ikut style kau)
   if (typeof AyohaBrowserBack !== 'undefined' && AyohaBrowserBack.push) {
     AyohaBrowserBack.push('FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram', function () {
    
        FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgramHide(true);
     });
   }
...
function FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgramHide(fromBack, animCfg) {
    // FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram_AddCardHide();
    ...
    if (isFloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgramOpen == 'Y') {
        ...
        if (animCfg) {
            _FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram.hide(Ext.fx.Animation(animCfg));
          } else {
            _FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram.hide();
          }
          isFloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgramOpen = 'N';
         
          // ✅ kalau bukan sebab browser BACK, kita sync history supaya state tak tinggal
          if (fromBack !== true) {
            AyohaBrowserBack.close('FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram');
          }
          _FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram.destroy();
          _FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram = null;
    }
...
var TodayCheckInCount = _DataStore_MerchantLoyaltyCampaign_LoadDiscountCardLoyaltyStore.findRecord('MembershipCardCode', val, 0, false, false, true);
...
Dashboard_SuccessCheckInController_DirectCheckIn(TodayCheckInCounts, EnterpriseAccNos, "MembershipCampaign-Discount","Online")
