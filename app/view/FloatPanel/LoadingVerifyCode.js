Ext.define('BuskartApp.view.FloatPanel.LoadingVerifyCode', {
});
...
function sendSMSverifycode(PhoneNo,Verifycode) {
    ...
    var message = "%0aCloud-Receipts.com verification code:" + Verifycode + "%0aThank you.%0aBuskartApp Technology Solution";
  ...
  //  SendSMSToURL("https://www.isms.com.my/isms_send.php?un=BuskartApp&pwd=P@55w0rd&dstno=" + PhoneNo + "&msg=" + message + "&type=1&sendid=" + PhoneNo + '-' + Verifycode + "");
  ...
  //  var str = '<iframe src="https://www.isms.com.my/isms_send.php?un=BuskartApp&pwd=P@55w0rd&dstno=' + PhoneNo + '&msg=' + message + '&type=1&sendid=' + PhoneNo - Verifycode + '" style="position: absolute; width: 0; height: 0"></iframe>';
