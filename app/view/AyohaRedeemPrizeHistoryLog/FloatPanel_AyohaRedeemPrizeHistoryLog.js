Ext.define('BuskartApp.view.AyohaRedeemPrizeHistoryLog.FloatPanel_AyohaRedeemPrizeHistoryLog', {

});

var _FloatPanel_AyohaRedeemPrizeHistoryLog;


var isFloatPanel_AyohaRedeemPrizeHistoryLogOpen = 'N';
...
function FloatPanel_AyohaRedeemPrizeHistoryLog() {

    _FloatPanel_AyohaRedeemPrizeHistoryLog =
     Ext.create('Ext.Panel', {

         xtype: 'container',
         height: 350,
         width: '95%',
         id: 'LoadingFloatPanel_AyohaRedeemPrizeHistoryLogID',
         draggable: false,
             ...
             initialize: function (c) {
                 this.element.on({
                     swipe: function (e, node, options) {
                         ...
                         if (e.direction == "left") {
                             _FloatPanel_AyohaRedeemPrizeHistoryLog.hide(Ext.fx.Animation({
                                 type: 'slideOut',
                                 direction: 'left',
                                 easing: 'cubic-bezier(.7,0,.7,1)',
                                 duration: 250
                         ...
                         isFloatPanel_AyohaRedeemPrizeHistoryLogOpen = 'N';
                     }
                 });
             }
         },
         ...
         items: {
             ...
             items: [
...

                 {
                     ...
                     id: 'containerFloatPanel_AyohaRedeemPrizeHistoryLogHeader',
                     //style: {
                     //    // background: '#D25959',
                     ...
                     items:
                            [
                                          ...
                                          {
                                              xtype: 'button',
                                              id: 'btnFloatPanel_AyohaRedeemPrizeHistoryLogBack',
                                              height: 30,
                                              width: 35,
                                              // iconCls: 'list',
...

            {
                ...
                xtype: 'container',
                margin: '10 0 0 0',
                id: 'FloatPanel_AyohaRedeemPrizeHistoryLogBorderBg',
                ...
                items: [
...

                    {
                        xtype: 'list',
                        //  flex: 1,
                        store: 'AyohaRedeemPrizeHistoryLogLoadByRedeemHistoryCodeStore',
                        id: 'FloatPanel_AyohaRedeemPrizeHistoryLogListID',
                        mode: 'SINGLE',
                        ...
                        itemTpl: '<div class="myContent">' +
                            ...
                            '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:18px;font-weight:normal;float:left;width:98%;"><b>{RedeemHistoryStatus}</b><br><font size=2>Remarks:{Remarks}</font><br><font size=2>Created By:{RedeemHistoryStatusBy}</font><br><font size=2>Created Date:{RedeemHistoryStatusDate}</font></div>' +
    ...
    return _FloatPanel_AyohaRedeemPrizeHistoryLog;
...
function FloatPanel_AyohaRedeemPrizeHistoryLogShow(val) {

    Ext.Viewport.remove(_FloatPanel_AyohaRedeemPrizeHistoryLog);
    this.overlay = Ext.Viewport.add(FloatPanel_AyohaRedeemPrizeHistoryLog());
    this.overlay.show();
    isFloatPanel_AyohaRedeemPrizeHistoryLogOpen = 'Y';
    FloatPanel_AyohaRedeemPrizeHistoryLog_AyohaRedeemPrizeHistoryLogLoadByRedeemHistoryCodeStore(val);
}


function FloatPanel_AyohaRedeemPrizeHistoryLogHide() {
    _FloatPanel_AyohaRedeemPrizeHistoryLog.hide(); isFloatPanel_AyohaRedeemPrizeHistoryLogOpen = 'N';
}




function FloatPanel_AyohaRedeemPrizeHistoryLog_AyohaRedeemPrizeHistoryLogLoadByRedeemHistoryCodeStore(val) {



    console.log(val);
    var RedeemHistoryCode = _DataStore_AyohaRedeemPrizeHistoryLoadRedeemHistoryStatusByStore.findRecord('ID', val, 0, false, false, true);
    var RedeemHistoryStatusBy = _DataStore_AyohaRedeemPrizeHistoryLoadRedeemHistoryStatusByStore.findRecord('ID', val, 0, false, false, true);

    console.log(RedeemHistoryCode.get('RedeemHistoryCode'));
    console.log(RedeemHistoryStatusBy.get('RedeemHistoryStatusBy'));
    Ext.getStore('AyohaRedeemPrizeHistoryLogLoadByRedeemHistoryCodeStore').getProxy().setExtraParams({
    ...
    Ext.StoreMgr.get('AyohaRedeemPrizeHistoryLogLoadByRedeemHistoryCodeStore').load();
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        Ext.StoreMgr.get('AyohaRedeemPrizeHistoryLogLoadByRedeemHistoryCodeStore').load();
        var myStore = Ext.getStore('AyohaRedeemPrizeHistoryLogLoadByRedeemHistoryCodeStore');
