Ext.define('BuskartApp.view.Dashboard.FloatPanel_DashboardMerchantReward_MembershipContestDetail', {
...
var _FloatPanel_DashboardMerchantReward_MembershipContestDetail=null;



function FloatPanel_DashboardMerchantReward_MembershipContestDetailCreateIfNeeded() {
    if (_FloatPanel_DashboardMerchantReward_MembershipContestDetail && !_FloatPanel_DashboardMerchantReward_MembershipContestDetail.destroyed) return;
                    ...
                    items:
                           [
...

                                         {
                                             ...
                                             ui: 'plain',
                                             handler: function () {
                                                FloatPanel_DashboardMerchantReward_MembershipContestDetailHide(false);
...

                                          {
                                              ...
                                              html:ayohaTheme_HeaderText('Membership Contest Details'),
...

                    {
...

                       {
                         ...
                         '<div class="ayohaMActions">' +
                           '<button class="ayohaCheckOutBtn" onclick="FloatPanel_DashboardMerchantReward_MembershipContestSelfieFormShow();">Join The Contest Now!</button>' +
...
function FloatPanel_DashboardMerchantReward_MembershipContestDetailShow(ID) {
    ...
    Ext.getCmp('htmlFloatPanel_DashboardMerchantReward_MembershipContestDetail').setHtml('<div class="myContent" style="background-color:white;width:100%;height:600px;">' +
                      ...
                      '<div style="width: 95%; float:left; height:30px; background:white; margin:-17px 0px 0px 0px;"><div style="font-family:Arial, sans-serif;font-size:10px;color:black;font-weight:normal;text-align:left;padding:0px 10px;">Contest Name:</div><br><div style="font-family:Arial, sans-serif;font-size:14px;color:black;font-weight:bold;margin:-18px 0px 0px 0px;text-align:left;padding:0px 10px;">' + ContestName.get('ContestName') + '</div></div><div style="width: 0%; float:left; height:30px; background:white; margin:-17px 0px 0px 0px;word-break: break-all;display:none;"><div style="margin:0px 0px 0px 0px;text-align:right;color:black;font-family: Arial; font-size:10px;word-wrap: break-word;word-break: break-all;white-space: break-spaces;font-weight:normal;width:100%;height:30px;padding:0px 7px;">Contest Host:<br><div style="margin:0px 0px 0px 0px;text-align:right;color:black;font-family: Arial; font-size:12px;word-wrap: break-word;word-break: break-all;white-space: break-spaces;font-weight:bold;width:100%;padding:0px 0px;"><div style="font-family:Arial, sans-serif;font-size:14px;color:black;font-weight:bold;text-align:right;width:100%;"><div style="margin:2px 0px 0px 0px;">' + EnterpriseName.get('EnterpriseName') + '</div></div></div></div></div><br>' +
