...
var detectIndex = [];
Ext.define('BuskartApp.view.Dashboard.mainDashboard', {
        ...
        items: [
...

            {
                ...
                items: [
                    ...
                    //    // hidden: true,
                    //    //  hidden:true,
                    //    id: 'tabpanelmainDashboard_Dashboard',
...

                    {
                        ...
                        //                    Ext.getCmp('tabpanelmainDashboard_Dashboard').setActiveItem(1);

                        //                }

                        //                if (e.direction == "right") {
                        //                    //  alert("Hey! I swipe left");
                        //                    Ext.getCmp('tabpanelmainDashboard_Dashboard').setActiveItem(0);
                        ...
                        items: [
...

                            {
                                ...
                                id: 'containermainDashboard_DashboardHeader',
                                ...
                                items:
                                    [
...

                                        {
                                            ...
                                            // margin: '10 0 0 0',
                                            style: 'background-color:transparent;',
                                            id: 'containermainDashboard_DashboardHaiUser',
                                            name: 'namecontainermainDashboard_DashboardHaiUser',
                                            ...
                                            items: [
...

                                                {
                                                    ...
                                                    items: [
                                                        {
                                                            xtype: 'button',
                                                            id: 'btnmainDashboard_DashboardPicProfileIcon',
                                                            height: 55,
                                                            width: 75,
                                                        ...
                                                        {
                                                            id: 'btnmainDashboard_DashboardRankIcon',
                                                            // hidden: true,
                                                            margin: '-20 0 0 30',
                                                            style: 'background-color:transparent;',
                                                            height: 22,
...

                                                {
                                                    ...
                                                    //height: 73,
                                                    //width: 180,
                                                    id: 'htmlmainDashboard_Dashboard_ProfileTitle',
                                                    html: '<div style="width:100%;background-color: transparent;text-align:left;border: 1px none white;font-size: 11px;font-weight:normal;color:black;margin:0px 0px 0px 0px">Hello!,</div><br><div style="width:100%;background-color: transparent;text-align:left;border: 1px none white;font-size: 16px;font-weight:bold;color:black;margin:-23px 0px 0px 0px">Tarmizi</div><br><div style="width:100%;background-color: transparent;text-align:left;border: 1px none white;font-size: 10px;font-weight:bold;color:black;margin:-25px 0px 0px 0px">Non-Ayoha Member</div>'
                                        ...
                                        },
                                        {
                                            ...
                                            margin: '-40 0 0 0',
                                            //  zIndex: 200,
                                            id: 'containermainDashboard_DashboardAyohaeWallet',
                                            name: 'namecontainermainDashboard_DashboardAyohaeWallet',
                                            // hidden:true,
                                            ...
                                            items: [
                                                ...
                                                //},
                                                {
                                                    ...
                                                    height: 40,
                                                    width: 100,
                                                    id: 'htmlmainDashboard_Dashboard_TitleHeaderTxtAyohaEwallet',
                                                    html: '<div style="background-color: transparent;text-align:right;border: 1px none white;font-size: 8px;font-weight:normal;color:black;margin:4px 0px 0px 0px;">BusKART e-Wallet</div><br><div style="width:100%;background-color: transparent;text-align:right;border: 1px none white;font-size: 16px;font-weight:bold;color:black;margin:-23px 0px 0px 0px">RM 00.00</div>'
                                                    // html: '<div style="width:100%;background-color: transparent;text-align:left;border: 1px none white;font-size: 9px;font-weight:normal;color:black;margin:0px 0px 0px 0px">Ayoha Reward</div><br><div style="width:100%;background-color: transparent;text-align:left;border: 1px none white;font-size: 9px;font-weight:normal;color:black;margin:-6px 0px 0px 0px">Client V 1.0</div>'
...

                                                {
                                                    ...
                                                    items: [
                                                        {
                                                            //xtype: 'button',
                                                            //id: 'btnmainDashboard_DashboardEwalletIcon',
                                                            height: 20,
                                                            width: 20,
                                                            margin: '0 0 0 0',
                                                            // iconCls: 'list',
                            ...
                            },
                            {
                                ...
                                items: [
                                    ...
                                    {
                                        xtype: 'container',
                                        id: 'container_Dashboard_HotBusker_Header',
                                        ...
                                        items: [
                                                ...
                                                items: [
                                                    {
                                                        ...
                                                        html: '<div style="color:black;text-align: left;font-size:16px;width:100%;"><b>Hot Busker !</b></div>'
...

                                            {
                                                ...
                                                items: [
                                                    ...
                                                    //    //width: '49%',
                                                    //    //height: 180,
                                                    //    html: '<video width="150" height="150"><source src="http://42.1.63.57/AyohaImgCard/AdvertisementVideo/CRCom-71100/aslam.mp4" type="video/mp4"></video>'
                                                    //},
                                ...
                                items: [
                                    {
                                        margin: '0 0 0 14',
                                        //   html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: auto;height:60px"></colgroup><thead><tr><th style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:center;vertical-align:top;word-break:normal"><div style="color:black;text-align: center;font-size:18px;width:100%;">Tarmizi Rahim</div><br><div style="color:black;text-align: center;font-size:12px;width:100%;margin:-27px 0px 0px 0px;">Ayoha Legendry Card</div><img src="resources/icons/editProfileWhite.png" width="30" height="30" alt="Company Name"></tr></thead></table>',
                                        html: '<div style="color:black;text-align: center;font-size:16px;width:100%;"><b>BuskART MAP</b></div>'
                                        // html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: 70%"><col style="width:30%"></colgroup><thead><tr><th style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:right;vertical-align:top;word-break:normal" rowspan="2"><div style="margin:0px 0px 0px -15px">TARMIZI RAHIM</div><br>Lagendary Card Mortal </th><th style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:left;vertical-align:middle;word-break:normal" rowspan="2">Medal</th></tr><tr></tr></thead></table>'
                                    },
                                    {
                                        xtype: 'spacer'
...

                            {
                                ...
                                items: [
...

                                    {
                                        width: '95%',
                                        height: 280,
                                        html:'<div id="map" style="height:280px;width:100%;"></div>'
                                    }
                    ...
                    {
                        xtype: 'container',
                        id: 'containermainDashboard_DashboardMerchantReward',
                        width: '100%',
                        height: '100%',
                        //style: "background-color: white;border-right:2px solid #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px #ECF0F1 white;border-radius: 50px 50px 50px 50px;",
                        style: "background-color: white;",
...

                    {
                        ...
                        id: 'containermainDashboard_Dashboard_MenuBottom',
                        ...
                        items:
                            [
                                    ...
                                    items: [
...

                                        {
                                            ...
                                            items: [
                                                ...
                                                {
                                                    xtype: 'container',
                                                    id: 'containermainDashboard_Dashboard_MenuBottom_Logout',
                                                    hidden: true,
                                                    //width: '33%',
                                                    //height: 30,
                                                    margin: '0 0 0 0',
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            xtype: 'button',
                                                            id: 'btn_mainDashboard_Dashboard_MenuBottom_Logout',
                                                            //  badgeText: '1',
                                                            margin: '0 0 0 0',
                                                        ...
                                                        {
                                                            xtype: 'container',
                                                            id: 'containermainDashboard_Dashboard_MenuBottom_LogoutTxt',
                                                            width: '100%',
                                                            layout: {
                                                                type: 'vbox',
                                                                pack: 'start',
                                                ...
                                                {
                                                    xtype: 'container',
                                                    id: 'containermainDashboard_Dashboard_MenuBottom_mainDashboard',
                                                    name: 'namecontainermainDashboard_Dashboard_MenuBottom_mainDashboard',
                                                    width: '19%',
                                                    margin: '0 0 0 0',
                                                    hidden: true,
                                                    // flex: 1,
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            xtype: 'button',
                                                            id: 'btn_mainDashboard_Dashboard_MenuBottom_mainDashboard',
                                                            //  badgeText: '1',
                                                            margin: '0 0 0 0',
                                                            ...
                                                            handler: function () {
                                                                ...
                                                                FloatPanel_mainDashboardMasterShow();
                                                        ...
                                                        {
                                                            xtype: 'container',
                                                            id: 'containermainDashboard_Dashboard_MenuBottom_mainDashboardTxt',
                                                            width: '100%',
                                                            layout: {
                                                                type: 'vbox',
                                                                pack: 'start',
                                                ...
                                                {
                                                    xtype: 'container',
                                                    id: 'containermainDashboard_Dashboard_MenuBottom_AyohaReward',
                                                    name: 'namecontainermainDashboard_Dashboard_MenuBottom_AyohaReward',
                                                    // hidden: true,
                                                    // width: '19%',
                                                    //height: 30,
                                                    margin: '0 0 0 0',
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            //xtype: 'button',
                                                            id: 'btn_mainDashboard_Dashboard_MenuBottom_AyohaReward',
                                                            //  badgeText: '1',
                                                            margin: '-2 0 0 0',
                                                        ...
                                                        {
                                                            xtype: 'container',
                                                            id: 'containermainDashboard_Dashboard_MenuBottom_AyohaRewardTxt',
                                                            width: '100%',
                                                            layout: {
                                                                type: 'vbox',
                                                                pack: 'center',
                                                ...
                                                {
                                                    xtype: 'container',
                                                    id: 'containermainDashboard_Dashboard_MenuBottom_MyStore',
                                                    name: 'namecontainermainDashboard_Dashboard_MenuBottom_MyStore',
                                                    // width: '19%',
                                                    //height: 30,
                                                    margin: '0 0 0 0',
                                                    flex: 1,
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            //  xtype: 'button',
                                                            id: 'btn_mainDashboard_Dashboard_MenuBottom_MyStore',
                                                            //  badgeText: '1',
                                                            margin: '0 0 0 0',
                                                        ...
                                                        {
                                                            xtype: 'container',
                                                            id: 'containermainDashboard_Dashboard_MenuBottom_MyStoreTxt',
                                                            width: '100%',
                                                            layout: {
                                                                type: 'vbox',
                                                                pack: 'center',
...

                                                {
                                                    ...
                                                    flex: 1.5,
                                                    // margin: '70 0 0 0',
                                                    id: 'containermainDashboard_Dashboard_MenuBottom_QrCodeScanOutter',
                                                    name: 'namecontainermainDashboard_Dashboard_MenuBottom_QrCodeScanOutter',
                                                    layout: {
                                                    ...
                                                    items: [
                                                        {
                                                            ...
                                                            width: 87,
                                                            // margin: '70 0 0 0',
                                                            id: 'containermainDashboard_Dashboard_MenuBottom_QrCodeScanInner',
                                                            layout: {
                                                            ...
                                                            items: [
                                                                {
                                                                    ...
                                                                    //width: 110,
                                                                    margin: '5 0 0 0',
                                                                    id: 'btnmainDashboard_Dashboard_MenuBottom_QrCodeScan',
                                                ...
                                                {
                                                    xtype: 'container',
                                                    id: 'containermainDashboard_Dashboard_MenuBottom_MyMembershipCard',
                                                    name: 'namecontainermainDashboard_Dashboard_MenuBottom_MyMembershipCard',
                                                    // width: '19%',
                                                    margin: '0 0 0 0',
                                                    flex: 1,
                                                    style: "background-color: transparent",
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            // xtype: 'button',
                                                            id: 'btn_mainDashboard_Dashboard_MenuBottom_MyMembershipCard',
                                                            //  badgeText: '1',
                                                            margin: '0 0 0 0',
                                                        ...
                                                        {
                                                            xtype: 'container',
                                                            id: 'containermainDashboard_Dashboard_MenuBottom_MyMembershipCardTxt',
                                                            width: '100%',
                                                            layout: {
                                                                type: 'vbox',
                                                                pack: 'center',
                                                ...
                                                {
                                                    xtype: 'container',
                                                    id: 'containermainDashboard_Dashboard_MenuBottom_Notification',
                                                    name: 'namecontainermainDashboard_Dashboard_MenuBottom_Notification',
                                                    // width: '19%',
                                                    //height: 30,
                                                    margin: '0 0 0 0',
                                                    flex: 1,
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            //xtype: 'button',
                                                            id: 'btn_mainDashboard_Dashboard_MenuBottom_Notification',
                                                            // badgeText: '10',
                                                            margin: '0 0 0 0',
                                                        ...
                                                        {
                                                            xtype: 'container',
                                                            id: 'containermainDashboard_Dashboard_MenuBottom_NotificationTxt',
                                                            width: '100%',
                                                            layout: {
                                                                type: 'vbox',
                                                                pack: 'center',
                                                ...
                                                {
                                                    xtype: 'container',
                                                    id: 'containermainDashboard_Dashboard_MenuBottom_MyPointHistory',
                                                    hidden: true,
                                                    //width: '33%',
                                                    //height: 30,
                                                    margin: '0 0 0 0',
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            xtype: 'button',
                                                            id: 'btn_mainDashboard_Dashboard_MenuBottom_MyPointHistory',
                                                            //  badgeText: '1',
                                                            margin: '0 0 0 0',
                                                        ...
                                                        {
                                                            xtype: 'container',
                                                            id: 'containermainDashboard_Dashboard_MenuBottom_MyPointHistoryTxt',
                                                            width: '100%',
                                                            layout: {
                                                                type: 'vbox',
                                                                pack: 'start',
                                                ...
                                                {
                                                    xtype: 'container',
                                                    id: 'containermainDashboard_Dashboard_MenuBottom_RedeemHistory',
                                                    hidden: true,
                                                    //width: '33%',
                                                    //height: 30,
                                                    margin: '0 0 0 0',
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            xtype: 'button',
                                                            id: 'btn_mainDashboard_Dashboard_MenuBottom_RedeemHistory',
                                                            //  badgeText: '1',
                                                            margin: '0 0 0 0',
                                                        ...
                                                        {
                                                            xtype: 'container',
                                                            id: 'containermainDashboard_Dashboard_MenuBottom_RedeemHistoryTxt',
                                                            width: '100%',
                                                            layout: {
                                                                type: 'vbox',
                                                                pack: 'start',
                                                ...
                                                {
                                                    xtype: 'container',
                                                    id: 'containermainDashboard_Dashboard_MenuBottom_Community',
                                                    hidden: true,
                                                    //width: '33%',
                                                    //height: 30,
                                                    margin: '0 0 0 0',
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            xtype: 'button',
                                                            id: 'btn_mainDashboard_Dashboard_MenuBottom_Community',
                                                            //  badgeText: '1',
                                                            margin: '0 0 0 0',
                                                        ...
                                                        {
                                                            xtype: 'container',
                                                            id: 'containermainDashboard_Dashboard_MenuBottom_CommunityTxt',
                                                            width: '100%',
                                                            layout: {
                                                                type: 'vbox',
                                                                pack: 'start',
...

                                {
                                    ...
                                    width: '40%',
                                    // margin: '70 0 0 0',
                                    id: 'containermainDashboard_Dashboard_MenuBottom_QrCodeScanOutter_Ori',
                                    name: 'namecontainermainDashboard_Dashboard_MenuBottom_QrCodeScanOutter_Ori',
                                    layout: {
                                    ...
                                    items: [
                                        {
                                            ...
                                            width: 110,
                                            // margin: '70 0 0 0',
                                            id: 'containermainDashboard_Dashboard_MenuBottom_QrCodeScanInner_Ori',
                                            layout: {
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    width: 110,
                                                    margin: '0 0 0 0',
                                                    id: 'btnmainDashboard_Dashboard_MenuBottom_QrCodeScan_Ori',
...
function initializeContainerSingleTapEvent() {
    ...
    var containerViewDashboardHaiUser = Ext.ComponentQuery.query('container[name=namecontainermainDashboard_DashboardHaiUser]')[0];
    ...
    var containerViewnamecontainermainDashboard_DashboardAyohaeWallet = Ext.ComponentQuery.query('container[name=namecontainermainDashboard_DashboardAyohaeWallet]')[0];
    var containerViewElnamecontainermainDashboard_DashboardAyohaeWallet = containerViewnamecontainermainDashboard_DashboardAyohaeWallet.element;
    containerViewElnamecontainermainDashboard_DashboardAyohaeWallet.on('tap',
        function (event, node, options, eOpts) {
    ...
    var containerViewMenuBottom_mainDashboard = Ext.ComponentQuery.query('container[name=namecontainermainDashboard_Dashboard_MenuBottom_mainDashboard]')[0];
    var containerViewElMenuBottom_mainDashboard = containerViewMenuBottom_mainDashboard.element;
    containerViewElMenuBottom_mainDashboard.on('tap',
        function (event, node, options, eOpts) {
    ...
    var containerViewMenuBottom_MyMembershipCard = Ext.ComponentQuery.query('container[name=namecontainermainDashboard_Dashboard_MenuBottom_MyMembershipCard]')[0];
    ...
    containerViewElMenuBottom_MyMembershipCard.on('tap',
        function (event, node, options, eOpts) {
            animatedClickTabExt('containermainDashboard_Dashboard_MenuBottom_MyMembershipCard');
            FloatPanel_MembershipCardList_MyMembershipCardShow();
        }
    );
    ...
    //var containerViewMenuBottom_NearestRedemption = Ext.ComponentQuery.query('container[name=namecontainermainDashboard_Dashboard_MenuBottom_NearestRedemption]')[0];
    ...
    var containerViewMenuBottom_AyohaReward = Ext.ComponentQuery.query('container[name=namecontainermainDashboard_Dashboard_MenuBottom_AyohaReward]')[0];
    ...
    //var containerViewMenuBottom_AyohaRewardContest = Ext.ComponentQuery.query('container[name=namecontainermainDashboard_Dashboard_MenuBottom_AyohaRewardContest]')[0];
    ...
    var containerViewMenuBottom_MyStore = Ext.ComponentQuery.query('container[name=namecontainermainDashboard_Dashboard_MenuBottom_MyStore]')[0];
    ...
    var containerViewMenuBottom_Notification = Ext.ComponentQuery.query('container[name=namecontainermainDashboard_Dashboard_MenuBottom_Notification]')[0];
    ...
    containerViewElMenuBottom_Notification.on('tap',
        function (event, node, options, eOpts) {
            animatedClickTabExt('containermainDashboard_Dashboard_MenuBottom_Notification');
            FloatPanel_AyohaNotificationShow();
        }
    );
    ...
    var containerViewMenuBottom_QrCodeScanOutter = Ext.ComponentQuery.query('container[name=namecontainermainDashboard_Dashboard_MenuBottom_QrCodeScanOutter]')[0];
...
function DashboardAyohaUserMainStore() {
    ...
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        if (isVerifiedUser == "YES") {
            Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHidden(false);
            Ext.getCmp('htmlmainDashboard_Dashboard_ProfileTitle').setHtml('<div style="width:100%;background-color: transparent;text-align:left;border: 1px none white;font-size: 11px;font-weight:normal;color:black;margin:0px 0px 0px 0px">Hello!,</div><br><div style="width:100%;background-color: transparent;text-align:left;border: 1px none white;font-size: 16px;font-weight:bold;color:black;margin:-25px 0px 0px 0px">' + AccName.toLowerCase() + '</div><br><div style="width:100%;background-color: transparent;text-align:left;border: 1px none white;font-size: 10px;font-weight:bold;color:black;margin:-26px 0px 0px 0px"><u>Ranking : ' + AyohaMember_Rank + '</u></div>');


            if (AyohaMember_Rank == "Black Iron") {
                //  Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:white;border-radius:50%;"><img src="resources/icons/Starter.png" alt="Image" style="width:15px;height:15px;margin:3px 0px 0px 4px;background-color:white;"></div>');
                Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:transparent;border-radius:50%;"><img src="resources/icons/ayohaRankingIcon/blackIron.png" alt="Image" style="width:20px;height:20px;margin:0px 0px 0px 0px;background-color:transparent;"></div>');

            }
            if (AyohaMember_Rank == "Bronze") {
                //  Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:white;border-radius:50%;"><img src="resources/icons/nomembercard.png" alt="Image" style="width:15px;height:15px;margin:3px 0px 0px 4px;background-color:white;"></div>');
                Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:transparent;border-radius:50%;"><img src="resources/icons/ayohaRankingIcon/Bronze.png" alt="Image" style="width:20px;height:20px;margin:0px 0px 0px 0px;background-color:transparent;"></div>');

            }
            if (AyohaMember_Rank == "Silver") {
                // Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:white;border-radius:50%;"><img src="resources/icons/vip.png" alt="Image" style="width:15px;height:15px;margin:3px 0px 0px 4px;background-color:white;"></div>');
                Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:transparent;border-radius:50%;"><img src="resources/icons/ayohaRankingIcon/Silver.png" alt="Image" style="width:20px;height:20px;margin:0px 0px 0px 0px;background-color:transparent;"></div>');

            }
            if (AyohaMember_Rank == "Gold") {
                //Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:white;border-radius:50%;"><img src="resources/icons/vvip.png" alt="Image" style="width:15px;height:15px;margin:3px 0px 0px 4px;background-color:white;"></div>');
                Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:transparent;border-radius:50%;"><img src="resources/icons/ayohaRankingIcon/Gold.png" alt="Image" style="width:20px;height:20px;margin:0px 0px 0px 0px;background-color:transparent;"></div>');

            }
            if (AyohaMember_Rank == "Platinum") {
                // Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:white;border-radius:50%;"><img src="resources/icons/goldmember.jpg" alt="Image" style="width:15px;height:15px;margin:3px 0px 0px 4px;background-color:white;"></div>');
                Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:transparent;border-radius:50%;"><img src="resources/icons/ayohaRankingIcon/Platinum.png" alt="Image" style="width:20px;height:20px;margin:0px 0px 0px 0px;background-color:transparent;"></div>');

            }
            if (AyohaMember_Rank == "King Club") {
                // Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:white;border-radius:50%;"><img src="resources/icons/icons/kingclubIcon.png" alt="Image" style="width:15px;height:15px;margin:3px 0px 0px 4px;background-color:white;"></div>');
                Ext.getCmp('btnmainDashboard_DashboardRankIcon').setHtml('<div style="width:22px;height:22px;background-color:transparent;border-radius:50%;"><img src="resources/icons/ayohaRankingIcon/kingclubIcon.png" alt="Image" style="width:20px;height:20px;margin:0px 0px 0px 0px;background-color:transparent;"></div>');
        ...
        if (globalPNUnread != "0") {
            Ext.getCmp('btnmainDashboard_DashboardPicProfile').setBadgeText(globalPNUnread);
            // Ext.getCmp('btn_mainDashboard_Dashboard_MenuBottom_Notification').setBadgeText(globalPNUnread);
            Ext.getCmp('btn_mainDashboard_Dashboard_MenuBottom_Notification').setHtml('<img src="resources/icons/NotificationPurple.png" width="20" height="20" alt="Company Name"><div style="margin:-30px 0px 0px 10px;text-align:center;font-size:12px;color:white;background-color:red;width:20px;height:20px;border-radius:50%;zIndex:100px;">' + globalPNUnread + '</div>');
        }
...
function AyohaRedeemPrize_LoadByRowStatusAndGCStore() {
    ...
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        //Ext.getCmp('containerAyohaRewardRedemption_carosel_APoint0').setHtml('<div style="color:purple;text-align: center;font-size:30px;width:100%;font-weight:bold">' + ItemPoint + '</div>');
        //Ext.getCmp('containerAyohaRewardRedemption_carosel_APointImg0').setHtml('<div style="color:black;text-align: center;font-size:10px;width:100%;font-weight:bold"><img src="' + ImgPath + '" alt="Image" style="width:70%;height:230px;"></div>');
        //Ext.getCmp('containerAyohaRewardRedemption_carosel_APointNameItemTxt0').setHtml('<div style="color:black;text-align: center;font-size:18px;width:100%;font-weight:bold">' + ItemName + '</div>');
        //Ext.getCmp('containerAyohaRewardRedemption_carosel_APointNameItemPriceTxt0').setHtml('<div style="color:black;text-align: center;font-size:12px;width:100%;font-weight:normal">Worth RM' + ItemPricePrizeCost + '</div>');
...
function Dashboard_AyohaHotMerchantSet01() {
    ...
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        document.getElementById('ext-element-253').className = 'marqueeExt';
