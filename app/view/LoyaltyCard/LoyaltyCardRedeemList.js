Ext.define('BuskartApp.view.LoyaltyCard.LoyaltyCardRedeemList', {
             ...
             initialize: function (c) {
                 this.element.on({
                     swipe: function (e, node, options) {
                         ...
                         RemovePages("LoyaltyCardRedeemListHide()");
                     }
                 });
             }
         },
...
function LoyaltyCardRedeemListShow() {
    ...
    this.overlay.show();
    AddRoutePages("LoyaltyCardRedeemListHide()");
...
function LoyaltyCardRedeemListHide() {
    if (isLoyaltyCardRedeemListOpen == "Y") {
