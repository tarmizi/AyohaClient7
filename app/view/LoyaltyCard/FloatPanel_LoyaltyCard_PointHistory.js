...
Ext.define('BuskartApp.view.LoyaltyCard.FloatPanel_LoyaltyCard_PointHistory', {

});

var _FloatPanel_LoyaltyCard_PointHistory;


var isFloatPanel_LoyaltyCard_PointHistoryOpen = 'N';
...
function FloatPanel_LoyaltyCard_PointHistory() {

    _FloatPanel_LoyaltyCard_PointHistory =
    Ext.create('Ext.Panel', {
        ...
        height: '100%',
        width: '100%',
        id: 'FloatPanel_LoyaltyCard_PointHistoryID',
        draggable: false,
            ...
            initialize: function (c) {
                this.element.on({
                    swipe: function (e, node, options) {
                        ...
                        //}
                        if (e.direction == "left") {
                            _FloatPanel_LoyaltyCard_PointHistory.hide(Ext.fx.Animation({
                                type: 'slideOut',
                                direction: 'left',
                                easing: 'cubic-bezier(.7,0,.7,1)',
                                duration: 250
        ...
        items: [
...

            {
                ...
                items: [
                        ...
                        items: [
                            {
                                ...
                                id: 'containerFloatPanel_LoyaltyCard_PointHistoryHeader',
                                style: {
                                    // background: '#D25959',
                                ...
                                items:
                                       [
                                                     ...
                                                     {
                                                         xtype: 'button',
                                                         id: 'btnFloatPanel_LoyaltyCard_PointHistoryBack',
                                                         height: 30,
                                                         width: 35,
                                                         // iconCls: 'list',
                                                         ...
                                                         ui: 'plain',
                                                         handler: function () {
                                                             FloatPanel_LoyaltyCard_PointHistoryHide();

                                                             //FloatPanel_LoyaltyCard_PointHistory_AddCardHide();
                                                             //_FloatPanel_LoyaltyCard_PointHistory.hide(Ext.fx.Animation({
                                                             //    type: 'slideOut',
                                                             //    direction: 'left',
                                                             //    easing: 'cubic-bezier(.7,0,.7,1)',
...

                                                      {
                                                       ...
                                                       {
                                                           margin: '0 0 0 0',
                                                           id: 'htmlFloatPanel_LoyaltyCard_PointHistory_TitleHeaderTxt',
                                                           html: '<font size=2 color=white><b>Point History</b></font>'
                                                       },
...

                                                              {
                                                                  ...
                                                                  width: 70,
                                                                  // margin: '70 0 0 0',
                                                                  id: 'containerFloatPanel_LoyaltyCard_PointHistoryHaiUser',
                                                                  layout: {
                                                                  ...
                                                                  items: [
                                                                      ...
                                                                      {
                                                                          margin: '0 0 0 0',
                                                                          id: 'htmlFloatPanel_LoyaltyCard_PointHistoryHaiUser',
                                                                      ...
                                                                      },
                                                                      {
                                                                          ...
                                                                          width: 70,
                                                                          // margin: '70 0 0 0',
                                                                          id: 'containerFloatPanel_LoyaltyCard_PointHistoryeWallet',
                                                                          layout: {
                                                                          ...
                                                                          items: [
                                                                               {
                                                                                   xtype: 'button',
                                                                                   id: 'btnFloatPanel_LoyaltyCard_PointHistoryeWallet',
                                                                                   margin: '4 0 0 -15',
                                                                                   height: 30,
                                                                                   width: 35,
                                                                                   // iconCls: 'list',
                                                              ...
                                                              },
                                                           {
                                                               ...
                                                               width: 40,
                                                               // margin: '70 0 0 0',
                                                               id: 'containerFloatPanel_LoyaltyCard_PointHistoryPictureUser',
                                                               layout: {
                                                               ...
                                                               items: [
                                                                   {
                                                                       ...
                                                                       width: 40,
                                                                       margin: '0 0 0 -11',
                                                                       id: 'btnFloatPanel_LoyaltyCard_PointHistoryInfo',
                                                                       //badgeText: "2",
...

                              {
                                  ...
                                  id: 'containerFloatPanel_LoyaltyCard_PointHistory_Master',
                                  style: {
                                      // background: '#D25959',
                                      background: 'transparent',
                                      // border: '2px'
                                  ...
                                  items: [
                                          ...
                                          items: [
                                                {
                                                    ...
                                                    items: [
                                                         {
                                                             margin: '10 0 0 0',
                                                             html: '<div style="color:white;text-align: center;font-size:12px;width:100%;font-weight:bold">TOTAL POINTS</div>',
                                                         },
                                                          {
                                                              margin: '-10 0 0 0',
                                                              id: 'htmlFloatPanel_LoyaltyCard_PointHistory_TotalStampCount',
                                                    ...
                                                    items: [
                                                          {
                                                              ...
                                                              margin: '2 0 0 0',
                                                              id: 'btnFloatPanel_LoyaltyCard_PointHistory_PointIcon',
                                                              //badgeText: "2",
...

                                                         {
                                                             ...
                                                             items: [
...

                                                                     {
                                                                         ...
                                                                         width: '50%',
                                                                         html: '<div style="width:100%;text-align:left;color:black;font-family: Arial; font-size:12px;"> &nbsp;&nbsp;&nbsp;&nbsp;Point Date&By</div>'
                                                                     },
...

                                      {
                                          ...
                                          height: '81%',
                                          store: 'LoyaltyStampLoadBySubscriberAccNoStores',
                                          id: 'FloatPanel_LoyaltyCard_PointHistory_StampHistoryList',
                                          mode: 'SINGLE',
                                          grouped: true,
                    ...
                    {
                        xtype: 'container',
                        id: 'containerFloatPanel_LoyaltyCard_PointHistoryTitleOutter',
                        width: '100%',
                        docked: 'bottom',
                        // hidden:true,
                        height: 40,
                        ...
                        items: [
                              ...
                              {
                                  xtype: 'button',
                                  id: 'btnFloatPanel_LoyaltyCard_PointHistorySearch',
                                  // hidden: true,
                                  //  badgeText: '1',
                                  margin: '2 0 0 -5',
                                  height: 40,
                             ...
                             {
                                 id: 'FloatPanel_LoyaltyCard_PointHistory_SearchTxt',
                                 margin: '0 0 0 0',
                                 width: '80%',
                                 height: 20,
                                 html: '<input type="text" id="input-FloatPanel_LoyaltyCard_PointHistory_SearchTxt" placeHolder="Search Enterprise" style="border-color:purple;color:black;width:100%;text-align: center;font-size:12px;">'
                             },
    ...
    return _FloatPanel_LoyaltyCard_PointHistory;
...
function FloatPanel_LoyaltyCard_PointHistoryShow() {

    Ext.Viewport.remove(_FloatPanel_LoyaltyCard_PointHistory);
    this.overlay = Ext.Viewport.add(FloatPanel_LoyaltyCard_PointHistory());
    this.overlay.show();
    isFloatPanel_LoyaltyCard_PointHistoryOpen = 'Y';
   // FloatPanel_LoyaltyCard_PointHistory_LoyaltyStampLoadBySubscriberAccNoStore();
   // document.getElementById("input-FloatPanel_LoyaltyCard_PointHistory_SearchTxt").addEventListener("keyup", LoyaltyStampLoadBySubscriberAccNoStoreOnKeyUp);
...
function FloatPanel_LoyaltyCard_PointHistoryHide() {

    _FloatPanel_LoyaltyCard_PointHistory.hide(); isFloatPanel_LoyaltyCard_PointHistoryOpen = 'N';
}
...
function FloatPanel_LoyaltyCard_PointHistory_LoyaltyStampLoadBySubscriberAccNoStore() {
    ...
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        Ext.getCmp('htmlFloatPanel_LoyaltyCard_PointHistory_TotalStampCount').setHtml('<div style="color:white;text-align: center;font-size:28px;width:100%;font-weight:bold">' + StampCount + '</div>');
        // adjustHeight();
...
function LoyaltyStampLoadBySubscriberAccNoStoreOnKeyUp() {
    ...
    var queryString = document.getElementById('input-FloatPanel_LoyaltyCard_PointHistory_SearchTxt').value;
