Ext.define('BuskartApp.view.QrCodeScannerInstascan.FloatPanel_QrCodeScanner_CenterLineMessage', {
...
function FloatPanel_QrCodeScanner_CenterLineMessageShow() {
    ...
    this.overlay.show();
    is_FloatPanel_QrCodeScanner_CenterLineMessageOpen = 'Y';


}
var is_FloatPanel_QrCodeScanner_CenterLineMessageOpen = 'N';

function FloatPanel_QrCodeScanner_CenterLineMessageHide() {

    if (is_FloatPanel_QrCodeScanner_CenterLineMessageOpen == 'Y') {
        _FloatPanel_QrCodeScanner_CenterLineMessage.hide();
        is_FloatPanel_QrCodeScanner_CenterLineMessageOpen = 'N';
