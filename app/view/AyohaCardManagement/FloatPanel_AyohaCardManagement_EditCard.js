Ext.define('BuskartApp.view.AyohaCardManagement.FloatPanel_AyohaCardManagement_EditCard', {
        ...
        /////////////////////////////////
        {
            ...
            items: [

                 {
                     ...
                     {
                         xtype: 'button',
                         id: 'btnFloatPanel_AyohaCardManagement_EditCard_StampCampaignRubberStamp',
                         //  badgeText: '1',
                         // hidden:true,
                         margin: '0 -5 -12 0',
                         height: 35,
                     ...
                     },
         {
             xtype: 'button',
             // hidden: true,
             id: 'txtFloatPanel_AyohaCardManagement_EditCard_StampCampaignRubberStamp',
             //  badgeText: '1',
             margin: '0 -7 -12 0',
             height: 40,
             width: 100,
             html: '<font size=2 color=white>Custome Rubber Stamp</font>',
             ui: 'plain',
             handler: function () {
...

                 {
                     ...
                     id: 'FloatPanel_AyohaCardManagement_EditCard_StampCampaignRubberStampList',
                     mode: 'SINGLE',
                     //  grouped: true,
                     disableSelection: true,
                     itemTpl: '<div style="margin:20px 0px 0px 180px"><font size=3>Tap To Edit</font></div>' + '<div style="margin:-6px 0px 0px 180px"><font size=1>Status:<u><b>{RowStatus}</b></u></font></div>' +
...
function FloatPanel_AyohaCardManagement_EditCardShow(StampCampaignName, StampCampaignCode, CreatedBy, ModifiedBy, CreatedDate, ModifiedDate, StampCardType, StartDateOnly, EndDateOnly, BackgroundImage, isAnimated, AnimatedInterval, StampRuleRemarks, isStampRulePopUp, LoyaltyCustomerType, StampCampaignPremiumQRCode) {
    ...
    Load_FloatPanel_AyohaCardManagement_EditCard_StampCampaignRubberStampLoadByStampCampaignCodeStore();
