      ...
      //                                           },
       {
           ...
           // html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: 70%"><col style="width:30%"></colgroup><thead><tr><th style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:right;vertical-align:top;word-break:normal" rowspan="2"><div style="margin:0px 0px 0px -15px">TARMIZI RAHIM</div><br>Lagendary Card Mortal </th><th style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:left;vertical-align:middle;word-break:normal" rowspan="2">Medal</th></tr><tr></tr></thead></table>'
...

                                {
                                    ...
                                    margin: '0 0 0 0',
                                   // hidden: true,
                                    id: 'htmlFloatPanel_DashboardMerchantMembershipEventxxxxpaid',
                                    style: "background-color: transparent;",
                                    ...
                                    items: [
...

                                        {
                                            ...
                                            itemTpl: [
                                             // '<div class="myContent" style="background-color:transparent;width:500px;height:380px;">',
                                              '<div style="width:100%;margin:auto; border-radius:15px; overflow:hidden; box-shadow:0 4px 20px rgba(0,0,0,0.3);">',
                                              '<div style="position:relative; height:280px; background-image:url(\'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTo8sRD9DXiKgEd0sTh66b2Ljls8laA8hQ0yw&s\'); background-size:cover; background-position:center;">',
                                              '<img src="https://5.imimg.com/data5/KA/JP/TU/SELLER-22794929/gold-membership-card.jpg" alt="Gold Member" style="position:absolute; top:130px; right:20px; width:200px; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.5); z-index:2;">',
                                              '<div style="position:absolute; bottom:0; left:0; width:100%; background-color:rgba(0,0,0,0.5); color:white; padding:10px; z-index:1;">',
                                              '<div style="font-size:12px;">Enjoy 4 Exclusive Perk</div>',
                                              '<div style="font-size:20px; font-weight:bold;">Get It NOW !</div>',
                                              '<div style="font-size:11px;">Membership Fees: RM35/Year</div>',
                                              '</div>',
                                              '</div>',
                                              '<div style="padding:15px; background-color:white;">',
                                              '<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:10px;">',
                                              '<div style="font-weight:bold; font-size:18px;">Kafe Kasbin</div>',
                                              '<div style="display:flex; align-items:center;">',
                                              '<img src="https://cdn-icons-png.flaticon.com/512/2920/2920029.png" width="30" alt="Restaurant Icon" style="margin-right: 5px;">',
                                              '<span style="font-size:12px; color:#555;">Restaurant</span>',
                                              '</div>',
                                              '</div>',
                                              '<div style="font-size:13px; color:#444;"> No. 149B, Jalan Besar Nilai,<br>Kampung Baru Nilai, 71800 Nilai,<br>Negeri Sembilan</div>',
                                              '<div style="margin-top:8px; font-size:14px; color:#333;">⭐⭐⭐⭐⭐ 4.5 ',
                                              '<a href="#" style="color:#3366cc; text-decoration:none;">859 Google reviews</a></div>',
                                              '</div>',
                                              '</div>'
                                             // '</div>'
                                            ].join('')
