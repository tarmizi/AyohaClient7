...
// Import global component styler
// Usage example:
// applyComponentStyle(this, { backgroundColor: 'red', color: 'white' });
// Make sure 'app/GlobalComponentStyler.js' is loaded in your HTML or app.js
...
Ext.define('BuskartApp.view.MyAccount.Dashboard', {
  ...
  html:
    '<div class="ayohaNotifWrap">' +
      '<img src="resources/icons/Notification.png" class="ayohaNotifIcon" />' +
      '<div class="ayohaNotifBadge" id="ayohaNotifBadgeUnread" style="display:none;">0</div>' +
    '</div>'
                               ...
                               {
                                xtype: 'container',
                                id: 'containerMyAccount_Dashboard_MyAccount',
                                name: 'namecontainerMyAccount_Dashboard_MyAccount',
                                hidden: true,
                              //ori  margin: '-10 0 0 0',
                                margin: '0 0 0 0',
                               width: 40,
                               height: 40,
                                ...
                                items: [
                                     ...
                                     {
                                         //xtype: 'button',
                                         id: 'btn_MyAccount_Dashboard_MyAccount',
                                         // badgeText: '10',
                                         margin: '0 0 0 -20',
    
                                         height: 32,
                                         width: 32,
                                         html: '<img src="resources/icons/founderWayang02.jpg"  style="width:32px;height:32px;border-radius:50%;border:2px white solid"  alt="Company Name">',
                                         //ui: 'plain',
                                         //handler: function () {
                                         ...
                                         //}
                                            ...
                                            //  hidden:true,
                                              ...
                                              //ori  style: 'border-right:2px solid #ECF0F1;border-left:2px solid #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px solid #ECF0F1;background: white;border-radius: 10px 10px 10px 10px;',                                             
                                               height: 35,
                                               width: 90,
                                               //width: 75,
                                               layout: {
...

{
    ...
    height:360,
    id:'containerCheckInRewardspacer01',
 style: 'background:transparent;',
 // style:"background-color:#491A7F;",
   layout: {
              ...
              items:[
                {
...

                    {
                       ...
                       // html: '<div style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:0px 0px 0px 0px"><b>Merchant Check-In</b></div>',
                        height:30,
                         html: '<div style="color:white;text-align: left;font-size:20px;width:100%;height:30px;margin:5px 0px 0px 0px"><b>Merchant Check-In</b></div>',
                  ...
                  
                    {
                        ...
                        // id: 'labelDashboard_LastCheckInTimeStamp',    
                        // html: '<div  style="color:white;text-align: left;font-size:10px;width:100%;margin:0px 0px 0px 0px;">00:00:00</div>'
                         html: '<div style="font-size:8px;color:white;background:transparnt;white-space:nowrap;font-weight:800px">*Max 3x check in per-merchant in a day</div>'
    ...
    
                {
                 ...
                 xtype: 'component',
                 html:
                 '<div onclick="FloatPanel_Membership_MembershipCardHubsUpgradeShow();" style="position:absolute;top:-78px;right:5px;background-color:transparent;border-radius:50%;' +
...

{
  xtype: 'container',
    ...
    margin: '-70 0 0 0',    
     height:160,
    //  style:"border-radius:22px; border:2px solid rgba(255,255,255,.65); background:linear-gradient(180deg,#ffffff 0%, #f6efff 100%); box-shadow: 0 2px 6px rgba(17,24,39,.06),    0 18px 44px -18px rgba(17,24,39,.18),    0 48px 120px -64px rgba(124,58,237,.22);",
     ...
     // style:"border-radius:22px; border:2px solid rgba(255,255,255,.65); background:linear-gradient(180deg,#ffffff 0%, #f6efff 100%); box-shadow: 0 2px 6px rgba(17,24,39,.06), 0 12px 28px -18px rgba(17,24,39,.16), 0 22px 56px -52px rgba(124,58,237,.18);",
    ...
    xtype: 'component',
     ...
     // height:170,
      ...
      '<div class="ayoha-emptyCard ayoha-emptyCardBorderBold">' +
        ...
        '<div class="ayoha-emptyTop">' +
          '<div class="ayoha-mapIcon">' +
            '<div class="ayoha-pinDot"></div>' +
    
            '<svg viewBox="0 0 24 24" aria-hidden="true">' +
              '<path fill="#7c3aed" opacity=".16" d="M3 6.5l6-2 6 2 6-2V18l-6 2-6-2-6 2V6.5z"/>' +
              '<path fill="#7c3aed" d="M9 4.5v15l-5 1.7V6.2L9 4.5zm6 2v15l-6-2v-15l6 2zm1-.4l5-1.7v14.8L16 20.8V6.1z"/>' +
            '</svg>' +
          '</div>' +
    
          '<div class="ayoha-emptyText">' +
            '<div class="ayoha-emptyTitle">No check-in yet today 😊</div>' +
            '<div class="ayoha-emptySub">Find a nearby merchant and start earning today.</div>' +
          '</div>' +
        '</div>' +
    
        '<div class="ayoha-ctaRow">' +
          '<button class="ayoha-ctaBtn" onclick="FloatPanel_Membership_MembershipCardHubsUpgradeShow();">' +
            '<span class="ayoha-ctaLeft">' +
              '<svg viewBox="0 0 24 24" aria-hidden="true">' +
            ...
            '<span class="ayoha-ptsBadge">+10 pts</span>' +
          '</button>' +
        '</div>' +
               ...
               [
                ...
                //                      },
                {
                            ...
                            width: 10,
                                  ...
                                  {
                                    xtype: 'component',
                                    id: 'htmlMyAccount_Dashboard_MemberStatus_MerchantCheckin_NonMember',
                                    hidden:true,
                                     height: 55,
                                     margin:'0 0 0 35',
                                                      width:110,
                                     html:'<div class="ayohaChip ayohaChipTopRight isNotMember">Not a member</div>'
                                 },

                                   {
                                      xtype: 'component',
                                      id: 'htmlMyAccount_Dashboard_MemberStatus_MerchantCheckin_Member',
                                      hidden:true,
                                       height: 55,
                                                        width:110,
...
xtype: 'container',
  width: '100%',
  margin:'0px 0px 0px 0px',
  id:'containerCheckInRewardProgress_Outter',
  height:480,
...
{
  xtype: 'container',
  id:'containerCheckInRewardProgress_PromotingMembershipCard_Inner',
  width: '100%',
  height:350,
  style: 'background:transparent;',
  layout: {
...
items:[

 {
    ...
    html:'<img src="https://setkita.com/AyohaImgCard/AyohaUserPicProfile/vinoth-2026314124241-5209025/KidsCard_PeachRainbow.png" style="width:60px;height:60px;border-radius:50%;border:2px solid white;" alt="Company Name"> </img>',
   // html: '<img src="resources/images/profile.png" style="color:#FFFFFF;text-align:center;font-size:21px;line-height:1.2;font-weight:800;letter-spacing:-0.35px;width:100%;text-shadow:0 2px 10px rgba(0,0,0,0.10);"></img>'
  },
  {
    width: '100%',
    margin: '0 0 0 0',
    id: 'html_Dashboard_1stline_PromotingMembershipCard',
    html: '<div id="html_Dashboard_1stline_PromotingMembershipCard_UserName" style="color:#FFFFFF;text-align:center;font-size:21px;line-height:1.2;font-weight:800;letter-spacing:-0.35px;width:100%;text-shadow:0 2px 10px rgba(0,0,0,0.10);">Hi, Farah </div>'
  },
  {
    width: '100%',
    hidden:true,
...
//             '<div class="ayohaPremiumBtn" style="display:inline-flex;">' +
//               //  '<div class="ayohaPremiumPerksChipIcon">✦</div>' +
//                 '<div>✨ Get The Membership Card Now 🎁</div>' +
//             '</div>' +
//         '</div>'
// },
]
...
items:[

 {
    ...
    height: 65,
    width: 65,
    id: 'html_Dashboard_1stlinePicProfile',
    html:'<img src="https://setkita.com/AyohaImgCard/AyohaUserPicProfile/vinoth-2026314124241-5209025/KidsCard_PeachRainbow.png" style="width:60px;height:60px;border-radius:50%;border:2px solid white;" alt="Company Name"> </img>',
   // html: '<img src="resources/images/profile.png" style="color:#FFFFFF;text-align:center;font-size:21px;line-height:1.2;font-weight:800;letter-spacing:-0.35px;width:100%;text-shadow:0 2px 10px rgba(0,0,0,0.10);"></img>'
  },
  {
...
margin:'0px 0px 0px 0px',
html:   
   '<div id="keepEarningCard" class="ayohaMCard" style="position:relative;overflow:hidden;">' +

     // =========================================================
     // FLOATING FAVORITE BUTTON (TOP LEFT)
     // =========================================================
     '<button id="btnAyohaFavorite_KeepEarning" onclick="FloatPanel_MerchantDetailPage_LikeDislikeStore();" style="' +
         'position:absolute;' +
         'top:12px;' +
         'left:32px;' +
         'z-index:30;' +
         ...
         'padding:0;' +
     '">' +
     '<div><img id="Dashboard_Favorite_UnFavorite_CheckInRewardProgress" src="resources/icons/unlovepurple.png" width="100%" height="26" alt="Company Name"></div>'

        //  '<svg viewBox="0 0 24 24" aria-hidden="true" style="width:21px;height:21px;stroke:#d946ef;stroke-width:2.2;fill:none;stroke-linecap:round;stroke-linejoin:round;">' +
        //      '<path d="M12 20.5l-1.35-1.22C5.4 14.54 2 11.46 2 7.7 2 4.62 4.42 2.2 7.5 2.2c1.74 0 3.41.81 4.5 2.09 1.09-1.28 2.76-2.09 4.5-2.09 3.08 0 5.5 2.42 5.5 5.5 0 3.76-3.4 6.84-8.65 11.58L12 20.5z"></path>' +
        //  '</svg>' 
         +
     '</button>' +
...

{
      ...
      html: 
   '<div id="maxEarningCard" class="ayohaMCard ayohaMMax" style="position:relative;overflow:hidden;">' +
     
     // Floating micro top actions
     '<div class="ayohaMicroTopLayer">' +

         // Favorite Button
         '<button id="btnAyohaFavorite_MaxReached" class="ayohaMicroFavBtn" onclick="FloatPanel_MerchantDetailPage_LikeDislikeStore();" aria-label="Favorite Merchant">' +
         '<div><img id="Dashboard_Favorite_UnFavorite_CheckInRewardProgressMaxReached" src="resources/icons/unlovepurple.png" width="100%" height="26" alt="Company Name"></div>'+
        ...
        //      '</svg>' +
         ...
         // Member Tag
         '<div id="tagAyohaMember_MaxReached" class="ayohaMicroMemberTag ayohaPulseSoft">' +
             '<span class="ayohaMicroMemberDot"></span>' +
             '<span class="ayohaMicroMemberText">Member</span>' +
         '</div>' +
     ...
     '<div class="ayohaMContent">' +
         ...
         '<div class="ayohaMHead" style="padding:0 10px; display:flex; align-items:center; gap:12px;">' +
             ...
             '<div class="ayohaMIcon" style="flex-shrink:0;">' +
                 ...
                 '<svg class="ayohaMTrophy" viewBox="0 0 24 24" aria-hidden="true" style="width:48px; height:48px;">' +
                   '<path class="tCup" d="M7 4h10v4c0 3.3-2.7 6-6 6s-6-2.7-6-6V4z" fill="#FFD700"/>' +
         ...
         // BAHAGIAN 4: BUTTON
         // =========================================================
         '<div class="ayohaMActions" style="padding:20px 10px; margin-top:2px; display:flex; gap:12px;">' +
   ...
   margin: '0 0 0 0',
    ...
    items:[
            ...
            items:[
                {
                    ...
                    '<style>' +
                      ...
                      '.ayoha-container {' +
                        'width: 100%; height: 80px; background: #efe7ff; border-radius: 16px 16px 0px 0px;' +
                    ...
                    '<div class="ayoha-container">' +
                      ...
                      // 3. Vouchers
                      '<div id="segVouchers" style="display:none" class="ayohaSeg" onclick="AyohaSelectLoyaltySeg(\'vouchers\')">' +
                      ...
                      // 4. Contest (NEW)
                      '<div id="segContest" style="display:none" class="ayohaSeg" onclick="AyohaSelectLoyaltySeg(\'contest\')">' +
                      ...
                      // 5. Event (NEW)
                      '<div id="segEvent" style="display:none" class="ayohaSeg" onclick="AyohaSelectLoyaltySeg(\'event\')">' +
                      ...
                      // 6. Discount (NEW)
                      '<div id="segDiscount" style="display:none" style="display:none" class="ayohaSeg" onclick="AyohaSelectLoyaltySeg(\'discount\')">' +
        ...
        },
        {
            ...
            style: "background-color: transparent;", 
            margin: '0 0 0 0',
            id: 'tabpanelDashboard_PerksInfo',
            width: '100%',
           // height: 250,
            height: 400,
            tabBarPosition: 'top',
 ...
 /////////Stamps Perks
          {
            ...
            height: 230,    
            margin: '0 0 0 0',
            title: 'containerTabpanelDashboard_PerksInfo_Stamps',
            id: 'containerTabpanelDashboard_PerksInfo_Stamps',
            style: 'background:transparent',
            layout: {
                type: 'vbox',
                pack: 'start',
            ...
            items:[
               
                        {
                            ...
                            height: 60,    
                            margin: '0 0 0 0',
                            id: 'containerTabpanelDashboard_PerksInfo_ButtonPerks_Stamps',
                            style: 'background:transparent;',
                            layout: {
                                type: 'vbox',
                                pack: 'center',
                            ...
                            items: [{
                                id: 'htmlTabpanelDashboard_PerksInfo_ButtonPerks_Stamps',
                                // html:                                
  ...
  '</div>',
                 ...
                 //  style: "background: rgba(255,255,255,.72);"+
                   ...
                   // "border-top: 1px solid rgba(255,255,255,.72);"+
                    ...
                    id:'containerTabpanelDashboard_PerksInfo_StampsStatus_Eligible',
                    layout: {
                        type: 'vbox',
                        pack: 'start',
                        align: 'center',
                    ...
                    items:[
                         ...
                         { margin: '4 0 0 0',
                            xtype: 'dataview',
                            id: 'listTabpanelDashboard_PerksInfo_StampsStatus_NA',
                            width: '96%',
                            height:'100%',
                            ...
                            itemTpl: new Ext.XTemplate([
                                ...
                                'style="' +
                                  'background:#fff;width:120px;height:140px;' +
                                  'display:flex;flex-direction:column;' +
                                  'border-radius:12px;' +
                                  'overflow:visible;' +                 // ✅ supaya badge boleh keluar (tak kena clip)
                                  'position:relative;' +                // ✅ anchor utk badge absolute
                                  'margin:0 5px 0 10px;' +
                                  'border:1px solid #E9E0F2;' +
                                //  'box-shadow:0 12px 30px rgba(24,39,75,.14),0 3px 10px rgba(24,39,75,.10);' +
                                '">' +
                              
                                  // IMAGE SECTION (kekal clip untuk gambar sahaja)
                                  '<div style="position:relative;overflow:hidden;flex:0 0 95px;border-radius:12px 12px 0 0;">' +
                                    '<div style="width:100%;height:100%;overflow:hidden;">' +
                                      '{ModifiedStampContent_CheckInSuccess}' +
                                    '</div>' +
                                  '</div>' +
                              
                                  // ✅ BADGE BULAT (overlap turun bawah image)
                                //   '<div style="' +
                                //     'position:absolute;' +
                                //     'top:55px;right:7px;' +             // ✅ adjust kalau nak turun lagi: 78px / 82px
                                ...
                                //    // 'box-shadow:0 12px 22px rgba(213,0,249,.32);' +
                                ...
                                //   '</div>' +
                                  ...
                                  '<div style="' +
                                  'position:absolute;' +
                                  'top:55px;right:0px;' +             // ✅ adjust kalau nak turun lagi: 78px / 82px
                                  'width:{ModifiedStampContentSequenceWidth};height:22px;border-radius:10px 0px 0px 10px;' +
                                  //'background:rgba(124,58,237,.95);' +
                                  '{ModifiedStampedRedeemStatusBackground}' +
                                  //'background: linear-gradient(135deg,#ff00de,#c800ff);' +
                                 // 'color:#fff;' +
                                  'display:flex;align-items:center;justify-content:center;' +
                                 ...
                                 // 'box-shadow:0 12px 22px rgba(213,0,249,.32);' +
                                  ...
                                  'z-index:99999;' +
                                '">' +
                                //  '{StampContentSequence}/11' +
                                  '{ModifiedStampContentSequence}' +
                                '</div>' +
          ...
          ///////// Point Perks Horizon
          {
            ...
            height: 230, 
            margin: '0 0 0 0',
            title: 'containerTabpanelDashboard_PerksInfo_Perks_Points',
            id: 'containerTabpanelDashboard_PerksInfo_Perks_Points',
            style: 'background:transparent',
            layout: {
                type: 'vbox',
                pack: 'start',
            ...
            items:[
               
                        {
                            ...
                            height: 58,    
                            margin: '0 0 0 0',
                            id: 'containerTabpanelDashboard_PerksInfo_ButtonPerks_Points',
                            style: 'background:transparent;',
                            layout: {
                                type: 'vbox',
                                pack: 'center',
                            ...
                            items: [{
                                id: 'htmlTabpanelDashboard_PerksInfo_ButtonPerks_Points',
                                // html:                                
                                //   '<div style="text-align:center;width:100%;">' +
                                //   '<div style="font-size:12px;font-weight:600;color:#7c3aed;">Digital Stamps</div>' + // ungu, bukan grey mati
                                //   '<div style="margin:4px auto 0 auto;width:32px;height:2px;border-radius:999px;' +
  ...
  '<div class="ayohaHdrCard">' +
    ...
    '<div class="ayohaHdrText">' +
      ...
      '<div class="ayohaHdrSub">Turn Spends into Savings</div>' +
    '</div>' +
  ...
  '</div>',
                 ...
                 //  style: "background: rgba(255,255,255,.72);"+
                   ...
                   // "border-top: 1px solid rgba(255,255,255,.72);"+
                    ...
                    title: 'StampsStatus_EligiblePerks',
                    id:'containerTabpanelDashboard_PerksInfo_PointsStatus_Eligible',
                    layout: {
                        type: 'vbox',
                        pack: 'start',
                        align: 'center',
                    ...
                    items:[
                         ...
                         { margin: '4 0 0 0',
                            xtype: 'dataview',
                            id: 'listTabpanelDashboard_PerksInfo_Point',
                            width: '96%',
                            height:'100%',
                            // store: _DataStore_DashboardStampCard_SuccessCheckIn_LoadStampCardPerkStore, // kalau ada store, letak balik sini
                            ...
                            itemTpl: new Ext.XTemplate([
                                ...
                                //     '         style="width:100%; height100%; object-fit:cover;">'+
                                //     '</div>' +
                                //   '</div>' +

                                  '<div style="position:relative;overflow:hidden;flex:0 0 95px;border-radius:12px 12px 0 0;background:#fff;">' +
  '<div style="width:100%;height:100%;overflow:hidden;">' +
    '<img src="{ImgPath}" alt="{ItemName}" ' +
...
'</div>' +
                                  ...
                                  // ✅ BADGE BULAT (overlap turun bawah image)
                                  '<div style="' +
                                  'position:absolute;top:55px;right:7px;' +
                                  'width:46px;height:46px;border-radius:999px;' +
                                  'background: linear-gradient(135deg,#ff00de,#c800ff);' +
                                  'color:#fff;' +
                                  'display:flex;flex-direction:column;' +     // ✅ penting
                                  'align-items:center;justify-content:center;' +
                                  'text-align:center;line-height:1;' +        // ✅ rapat cantik
                                  'font-size:10px;font-weight:900;' +
                                  'border:2px solid #fff;' +
                                  'z-index:99999;' +
                                '">' +
                                  '<div style="font-size:10px;font-weight:900;margin-top:1px;">{ItemPoint}</div>' +
                                  '<div style="font-size:9px;font-weight:800;opacity:.95;margin-top:2px;">Point</div>' +
                                '</div>' +
         ...
         /////////Voucher Perks
  {
    ...
    height:260,    
    margin: '0 0 0 0',
    title: 'containerTabpanelDashboard_PerksInfo_Perks_Vouchers',
    id: 'containerTabpanelDashboard_PerksInfo_Perks_Vouchers',
    style: 'background:transparent',
    layout: {
        type: 'vbox',
        pack: 'start',
    ...
    items:[
        {
            ...
            height: 58,    
            margin: '0 0 0 0',
            id: 'containerTabpanelDashboard_PerksInfo_ButtonPerks_Vouchers_Outter',
            style: 'background:transparent;',
            layout: {
                type: 'vbox',
                pack: 'center',
            ...
            items: [{
                id: 'htmlTabpanelDashboard_PerksInfo_ButtonPerks_Vouchers',              
                width: '95%',
                height:'100%', 
                html:
'<div class="ayohaHdrCard">' +
'<div class="ayohaHdrIcon">' +
'<img src="resources/icons/VoucherPerks03.png" style="width:20px;height:20px;" /> ' +
// '<svg width="18" height="18" viewBox="0 0 24 24" fill="none">' +
// '<path d="M7 3h10a2 2 0 0 1 2 2v5.2a3 3 0 0 1 0 5.6V19a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-3.2a3 3 0 0 1 0-5.6V5a2 2 0 0 1 2-2Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>' +
// '<path d="M9 8h6M9 12h6M9 16h4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>' +
// '</svg>' +
...
'<div class="ayohaHdrSub">Gifts That Keep on Giving</div>' +
'</div>' +
...
'</div>',
       ...
       
         {
           ...
           margin: '-2 0 0 0',
            ...
            id:'containerTabpanelDashboard_PerksInfo_VouchersStatus_Eligible',
            layout: {
                type: 'vbox',
                pack: 'start',
                align: 'center',
            ...
            items:[
                 ...
                 {margin: '8 0 0 0',
                    xtype: 'dataview',
                    id: 'listTabpanelDashboard_PerksInfo_Voucher',
                    width: '96%',
                    height:'100%',
         ...
         /////////Contest Perks
         {
            ...
            height:390,    
            margin: '0 0 0 0',
            title: 'containerTabpanelDashboard_PerksInfo_Perks_Contests',
            id: 'containerTabpanelDashboard_PerksInfo_Perks_Contests',
            style: 'background:transparent',
            layout: {
                type: 'vbox',
                pack: 'start',
            ...
            items:[
                {
                    ...
                    height: 58,    
                    margin: '0 0 0 0',
                    id: 'containerTabpanelDashboard_PerksInfo_ButtonPerks_Contests_Outter',
                    style: 'background:transparent;',
                    layout: {
                        type: 'vbox',
                        pack: 'center',
                    ...
                    items: [{
                        id: 'htmlTabpanelDashboard_PerksInfo_ButtonPerks_Contests',              
                        width: '95%',
                        height:'100%', 
                        html:
        '<div class="ayohaHdrCard">' +
        '<div class="ayohaHdrIcon">' +
        // stamp icon (SVG)
        '<img src="resources/icons/ContestPerks02.png" style="width:20px;height:20px;" /> ' +
        // '<svg width="18" height="18" viewBox="0 0 24 24" fill="none">' +
        // '<path d="M7 3h10a2 2 0 0 1 2 2v5.2a3 3 0 0 1 0 5.6V19a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-3.2a3 3 0 0 1 0-5.6V5a2 2 0 0 1 2-2Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>' +
        // '<path d="M9 8h6M9 12h6M9 16h4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>' +
        // '</svg>' +
        ...
        '<div class="ayohaHdrSub">Unlock Winning Moments</div>' +
        '</div>' +
        ...
        '</div>',
               ...
               
                 {
                    ...
                    title: 'VouchersStatus_EligiblePerks',
                    id:'containerTabpanelDashboard_PerksInfo_ContestsStatus_Eligible',
                    layout: {
                        type: 'vbox',
                        pack: 'start',
                        align: 'center',
                    ...
                    items:[
        ...
        
                         {
                            margin: '8 0 0 0',
                            xtype: 'dataview',
                            id: 'listTabpanelDashboard_PerksInfo_Contest',
                            width: '96%',
                            height:'100%',
            ...
            /////////Event Perks
            {
                ...
                height:390,    
                margin: '0 0 0 0',
                title: 'containerTabpanelDashboard_PerksInfo_Perks_Events',
                id: 'containerTabpanelDashboard_PerksInfo_Perks_Events',
                style: 'background:transparent',
                layout: {
                    type: 'vbox',
                    pack: 'start',
                ...
                items:[
                    {
                        ...
                        height: 58,    
                        margin: '0 0 0 0',
                        id: 'containerTabpanelDashboard_PerksInfo_ButtonPerks_Events_Outter',
                        style: 'background:transparent;',
                        layout: {
                            type: 'vbox',
                            pack: 'center',
                        ...
                        items: [{
                            id: 'htmlTabpanelDashboard_PerksInfo_ButtonPerks_Events',              
                            width: '95%',
                            height:'100%', 
                            html:
            '<div class="ayohaHdrCard">' +
            '<div class="ayohaHdrIcon">' +
            '<img src="resources/icons/EventPerks03.png" style="width:20px;height:20px;" /> ' +
            // '<svg width="18" height="18" viewBox="0 0 24 24" fill="none">' +
            // '<path d="M7 3h10a2 2 0 0 1 2 2v5.2a3 3 0 0 1 0 5.6V19a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-3.2a3 3 0 0 1 0-5.6V5a2 2 0 0 1 2-2Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>' +
            // '<path d="M9 8h6M9 12h6M9 16h4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>' +
            // '</svg>' +
            ...
            '<div class="ayohaHdrSub">You are respectively selected to join our event as listed here</div>' +
            '</div>' +
                   ...
                   
                     {
                        ...
                        //  style: "background: rgba(255,255,255,.72);"+
                          ...
                          // "border-top: 1px solid rgba(255,255,255,.72);"+
                           ...
                           "border-bottom: 1px solid rgba(214,0,255,.16);"+
                           "backdrop-filter: blur(6px);",
                        id:'containerTabpanelDashboard_PerksInfo_EventsStatus_Eligible',
                        layout: {
                            type: 'vbox',
                            pack: 'start',
                            align: 'center',
                        ...
                        items:[
            ...
            
                             {
                                margin: '8 0 0 0',
                                xtype: 'dataview',
                                id: 'listTabpanelDashboard_PerksInfo_Event',                      
                                width: '96%',
                                height:'100%',
               ...
               /////////Discount Perks
         {
            ...
            height:390,    
            margin: '0 0 0 0',
            title: 'containerTabpanelDashboard_PerksInfo_Perks_Discounts',
            id: 'containerTabpanelDashboard_PerksInfo_Perks_Discounts',
            style: 'background:transparent',
            layout: {
                type: 'vbox',
                pack: 'start',
            ...
            items:[
                {
                    ...
                    height: 58,    
                    margin: '0 0 0 0',
                    id: 'containerTabpanelDashboard_PerksInfo_ButtonPerks_Discounts_Outter',
                    style: 'background:transparent;',
                    layout: {
                        type: 'vbox',
                        pack: 'center',
                    ...
                    items: [{
                        id: 'htmlTabpanelDashboard_PerksInfo_ButtonPerks_Discounts',              
                        width: '95%',
                        height:'100%', 
                        html:
        '<div class="ayohaHdrCard">' +
        '<div class="ayohaHdrIcon">' +
        '<img src="resources/icons/DiscountPerks03.png" style="width:20px;height:20px;" /> ' +
        // '<svg width="18" height="18" viewBox="0 0 24 24" fill="none">' +
        // '<path d="M7 3h10a2 2 0 0 1 2 2v5.2a3 3 0 0 1 0 5.6V19a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-3.2a3 3 0 0 1 0-5.6V5a2 2 0 0 1 2-2Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>' +
        // '<path d="M9 8h6M9 12h6M9 16h4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>' +
        // '</svg>' +
        ...
        '</div>',
               ...
               
                 {
                    ...
                    id:'containerTabpanelDashboard_PerksInfo_DiscountsStatus_Eligible',
                    layout: {
                        type: 'vbox',
                        pack: 'start',
                        align: 'center',
                    ...
                    items:[
        ...
        
                         {
                            margin: '8 0 0 0',
                            xtype: 'dataview',
                            id: 'listTabpanelDashboard_PerksInfo_Discount',
                            width: '96%',
                            height:'100%',
          ...
          ///////// Point Perks Horizon
          {
            ...
            items:[
               
                        {
                            ...
                            name:'nameContainerDashboardHeader_ButtonPerks_Points',
                            style: 'background:transparent;',
                            layout: {
                                type: 'vbox',
                                pack: 'center',
...
'<table class="ayohaCardTable" OnClick="FloatPanel_MembershipCardList_MyMembershipCardOpenMembershiCardDetail(`{MembershipCardCode}`,`{EnterpriseAccNo}`,`{isMembershipCardSubscribed}`,`{MembershipCardFeePaymentCycle}`,`{CountStar}`,`{CountReviewer}`)">',
  '<tbody>',
    ...
    '<tr>',
      '<td class="ayohaCardMid" colspan="3"><br>',
        '<div class="ayohaCardType">{MembershipCardType}</div>',
        '<div class="ayohaCardNo">{MembershipNo}</div>',
        '<div class="ayohaCardName">{AyohaUserAccountName}</div>',
      '</td>',
    '</tr>',
    ...
    '<tr>',
      '<td class="ayohaCardColL" colspan="2">',
        '<div class="k">Member Since</div>',
        '<div class="v">{MembershipStartDate_MonthYearOnly}</div>',
      '</td>',
      '<td class="ayohaCardColR">',
        '<div class="k">Valid Until</div>',
        ...
        hidden:true,
          ...
          },
          {
            ...
            margin: '10 0 0 0',
             height: 90,
            style: 'background-color: transparent;',
            id: 'containerDashboard_MerchantDetailPage_EnterpriseInfo',
            ...
            items: [
                {
                    ...
                    height: 85,
                    style: 'background-color: transparent;',
                    id: 'containerDashboard_MerchantDetailPage_EnterpriseInfo_Logo',
                    ...
                    items: [
                        {
                            width: '100%',
                            height: 85,
                            id: 'htmlDashboard_MerchantDetailPage_EnterpriseInfo_Logo',
...
height: 40,
style: 'background-color: transparent;',
id: 'containerDashboard_MerchantDetailPage_EnterpriseInfo_Direction',
...
hidden:true,
style: 'background-color: transparent;',
id: 'containerDashboard_MerchantDetailPage_EnterpriseInfo_OnlineStore',
name:'namecontainerDashboard_MerchantDetailPage_EnterpriseInfo_OnlineStore',
...
'</span>' +
  ...
  '<style>' +
    ...
    '.ayohaCtaWrap{width:100%;height:56px;display:flex;align-items:center;justify-content:center;}' +  // ✅ taller

    '.ayohaCtaBtn{position:relative;width:100%;height:56px;display:flex;align-items:center;justify-content:space-between;gap:10px;' +
    ...
    '.ayohaCtaTextWrap{flex:1 1 auto;min-width:0;display:flex;flex-direction:column;align-items:flex-start;justify-content:center;' +
      'gap:3px;text-align:left;}' +

    '.ayohaCtaTitle{display:block;font:900 13px/1.05 system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;' +
      'white-space:nowrap;overflow:hidden;text-overflow:ellipsis;letter-spacing:.2px;}' +

    '.ayohaCtaSub{display:block;font:700 11px/1.05 system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;' +
  ...
  '</style>'
          ...
          items: [
              {
                  ...
                  height: 42,
                  style: 'background-color: transparent;',
                  id: 'containerDashboard_MerchantDetailPage_EnterpriseCheckInIcon',
              ...
              },
               {
                   ...
                   height: 35,
                   style: 'background-color: transparent;',
                   id: 'containerDashboard_MerchantDetailPage_EnterpriseCheckInDetails',
      ...
      },
      {
      ...
      },
        {
            ...
            height: 35,
            style: 'background-color: transparent;',
            id: 'containerDashboard_MerchantDetailPage_EnterpriseWorkingHour',
            ...
            items: [
                {
                    ...
                    height: 26,
                    style: 'background-color: transparent;',
                    id: 'containerDashboard_MerchantDetailPage_EnterpriseWorkingHourIcon',
                ...
                },
                 {
                     ...
                     height: 35,
                     style: 'background-color: transparent;',
                     id: 'containerDashboard_MerchantDetailPage_EnterpriseWorkingHourDetails',
                     ...
                     items: [
                         {
                             ...
                             height: 35,
                             margin: '-3 0 0 0',
                             id: 'htmlDashboard_MerchantDetailPage_EnterpriseWorkingHourDetails',                                                             
...

        {
            ...
            height: 35,
            style: 'background-color: transparent;',
            id: 'containerDashboard_MerchantDetailPage_EnterpriseBusinessContactNo',
            ...
            items: [
                {
                    ...
                    height: 26,
                    style: 'background-color: transparent;',
                    id: 'containerDashboard_MerchantDetailPage_EnterpriseContactIcon',
                ...
                },
                 {
                     ...
                     height: 35,
                     style: 'background-color: transparent;',
                     id: 'containerDashboard_MerchantDetailPage_EnterpriseContactDetails',
                     ...
                     items: [
                         {
                             ...
                             height: 35,
                             margin: '-3 0 0 0',
                             id: 'htmlDashboard_MerchantDetailPage_EnterpriseContactDetails',                                                              
...

        {
            ...
            height: 35,
            style: 'background-color: transparent;',
            id: 'containerDashboard_MerchantDetailPage_EnterpriseWhatsAppBusinessContactNo',
            ...
            items: [
                {
                    ...
                    height: 26,
                    style: 'background-color: transparent;',
                    id: 'containerDashboard_MerchantDetailPage_EnterpriseWhatsAppContactIcon',
                ...
                },
                 {
                     ...
                     height: 35,
                     style: 'background-color: transparent;',
                     id: 'containerDashboard_MerchantDetailPage_EnterpriseWhatsAppDetails',
                     ...
                     items: [
                         {
                             ...
                             height: 35,
                             margin: '-3 0 0 0',
                             id: 'htmlDashboard_MerchantDetailPage_EnterpriseWhatsAppDetails',                                                              
            ...
            items: [
                {
                    ...
                    height: 26,
                    style: 'background-color: transparent;',
                    id: 'containerDashboard_MerchantDetailPage_EnterpriseLoveUsIcon',
                    ...
                    items: [
                        {
                            width: '100%',
                            height: 26,
                            id: 'htmlDashboard_MerchantDetailPage_EnterpriseLoveUsIcon',
                             ...
                             items: [
                                 {
                                    ...
                                    // name: 'namecontainerFloatPanel_AyohaStore_ReviewAndRate',
                                     ...
                                     items: [
                                         {
                                             margin: '0 0 0 5',
                                             id: 'htmlDashboard_MerchantDetailPage_ReviewAndRateCount',
                            ...
                            // width: '37%',
                             ...
                             items: [
                              ...
                              items:[
                                  {
                                      margin: '-10 8 0 0',
                                      id: 'htmlDashboard_MerchantDetailPage_CountbadgeText',
           ...
           margin: '30 0 0 0',
            ...
            items: [
                
                 {
                     ...
                     //   html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: auto;height:60px"></colgroup><thead><tr><th style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:center;vertical-align:top;word-break:normal"><div style="color:black;text-align: center;font-size:18px;width:100%;">Tarmizi Rahim</div><br><div style="color:black;text-align: center;font-size:12px;width:100%;margin:-27px 0px 0px 0px;">Ayoha Legendry Card</div><img src="resources/icons/editProfileWhite.png" width="30" height="30" alt="Company Name"></tr></thead></table>',
                   // html: '<div style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:0px 0px 0px 0px"><b><i>Visit our e-commerce site</i></b></div>'
                 
                 
                  html: '<div     style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:0px 0px 0px 0px"><b>🛒 Other Marketplaces</b></div><br> <div style="margin:-24px 0px 0px 25px;font-size:11px;color:#6b7280;">Visit our external marketplace links.</div>'
...
//          },
 {
   ...
   html: '<div     style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:0px 0px 0px 0px"><b>🌐 Our Social Media/Website</b></div><br> <div style="margin:-24px 0px 0px 25px;font-size:11px;color:#6b7280;">Stay Connected with Us.</div>'
            ...
            items: [
                 {
                    ...
                    margin: '10 0 0 14',
                    //   html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: auto;height:60px"></colgroup><thead><tr><th style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:center;vertical-align:top;word-break:normal"><div style="color:black;text-align: center;font-size:18px;width:100%;">Tarmizi Rahim</div><br><div style="color:black;text-align: center;font-size:12px;width:100%;margin:-27px 0px 0px 0px;">Ayoha Legendry Card</div><img src="resources/icons/editProfileWhite.png" width="30" height="30" alt="Company Name"></tr></thead></table>',
                //   html: '<div     style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:0px 0px 0px 0px"><b>Check-Out</b></div>'
                   html: '<div onclick="FloatPanel_CheckOut_NonMemberShow()"    style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:0px 0px 0px 0px"><b>👋Check-Out</b></div><br> <div style="margin:-24px 0px 0px 0px;font-size:11px;color:#3A0ca3;font-weight:bold;">See you again , check in next time for more rewards!</div>'
           
                 },
                 //See you again—check in next time for more rewards!
                 {
                     xtype: 'spacer'
                 },
                 {
...

{
  ...
  height: 360,
 // hidden: false,
  id:'containerDashboard_Your_Activity',
 // margin: '0 0 0 0',
 margin: '0 0 0 0',
  // style: 'border-right:2px solid #ECF0F1;border-left:2px solid #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px solid #ECF0F1 ;background: white;border-radius: 0px 15px 15px 0px;',
  //  style: 'border-right:2px none #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px none #ECF0F1;border-top:2px none #ECF0F1 ;background: red;',
  ...
  items:[
    ...
    //  height: 40,
     // hidden: false,
      id:'containerDashboard_Your_ActivityTitle',
     // margin: '0 0 0 0',
     margin: '0 0 0 0',
      // style: 'border-right:2px solid #ECF0F1;border-left:2px solid #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px solid #ECF0F1 ;background: white;border-radius: 0px 15px 15px 0px;',
      //  style: 'border-right:2px none #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px none #ECF0F1;border-top:2px none #ECF0F1 ;background: red;',
      ...
      items: [
           {
              ...
              margin: '0 0 0 14',
              //   html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: auto;height:60px"></colgroup><thead><tr><th style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:center;vertical-align:top;word-break:normal"><div style="color:black;text-align: center;font-size:18px;width:100%;">Tarmizi Rahim</div><br><div style="color:black;text-align: center;font-size:12px;width:100%;margin:-27px 0px 0px 0px;">Ayoha Legendry Card</div><img src="resources/icons/editProfileWhite.png" width="30" height="30" alt="Company Name"></tr></thead></table>',
             html: '<div     style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:10px 0px 0px 10px"><b>⚡ Your Activity</b></div><br> <div style="margin:-21px 0px 0px 12px;font-size:11px;color:#6b7280;">Your fovaorite merchant check in and your recent checik</div>'
...

    {
      ...
      items: [
        
        {
          xtype: 'component',
          itemId: 'recent',
          cls: 'ayohaTogglePill isActive',
          flex: 1,
          html: '📍 Recent check in',
          listeners: {
            tap: {
              element: 'element',
              fn: function () {
                var cmp  = this.component;
                var wrap = cmp.up('container[cls~=ayohaToggleWrap]');
    
                wrap.items.each(function(it){ it.removeCls('isActive'); });
                cmp.addCls('isActive');
    
                Ext.getCmp('activityCard').setActiveItem(0);
              }
            }
          }
        },
          ...
          listeners: {
            tap: {
              ...
              fn: function () {
                ...
                Ext.getCmp('activityCard').setActiveItem(1);
              }
            }
          }
        },
    ...
    
    {
       ...
       //  style: 'background:  #faf5ff;border-bottom:1px solid  #E5E7EB;border-top:2px none #faf5ff;border-left:2px none #faf5ff;border-right:2px none #faf5ff;',
          ...
          items:[
            ...
            style:'background-color: rgba(255, 255, 255, 0);',
              ...
              // ✅ PASTIKAN store ada (ini punca biasa “tak jalan”)
              ...
              itemTpl:
                  '<div OnClick="FloatPanel_Membership_MembershipCardHubsUpgrade_CheckInPageShow(`{EnterpriseLogoPath}`,`{EnterpriseName}`,`{EnterpriseAddress}`,`{CheckInCount}`,`{EnterpriseAccNo}`,`Recently-CheckIn`,`Online`);" class="ayohaFavCard {[xindex==1 ? "isTop" : ""]}">' +
                    ...
                    '<div class="logoWrap">' +
                      '<img src="{EnterpriseLogoPath}" onerror="this.src=\'resources/icons/defaultMerchant.png\'"/>' +
                    '</div>' +
          
                    '<div class="name">{EnterpriseName}</div>' +
                    '<div class="meta">{RelativeCheckInTime}</div>' +
          
                    '<div class="row">' +
                      '<div class="pts">+{AyohaRewardPointCheckIn} pts</div>' +
                      '<div class="cta" onclick="FloatPanel_CheckInShow(\'{EnterpriseAccNo}\')">Check-In</div>' +
                    '</div>' +
                  '</div>'
            }
      ...
      //   itemTpl: new Ext.XTemplate(
      //     '<div class="rcCard">',
      //       '<div class="rcBadge">+{AyohaRewardPointCheckIn}A.Pts</div>',
      //       '<div class="rcLogoWrap">',
      //        '<img class="rcLogo" src="{EnterpriseLogoPath}" onerror="this.src=\'resources/icons/default_logo.png\'" />' +
      //       '</div>',
      //       '<div class="rcName">{EnterpriseName:htmlEncode}</div>',
      //       '<div class="rcTime">{RelativeCheckInTime:htmlEncode}</div>',
      //     '</div>'
      //   )
      // }
    ...
    //  style: 'background:  #faf5ff;border-bottom:1px solid  #E5E7EB;border-top:2px none #faf5ff;border-left:2px none #faf5ff;border-right:2px none #faf5ff;',
      ...
      style:'background-color: rgba(255, 255, 255, 0);',
        ...
        itemTpl:
            '<div  OnClick="FloatPanel_Membership_MembershipCardHubsUpgrade_CheckInPageShow(`{EnterprisesLogo}`,`{EnterprisesName}`,`{EnterpriseAddress}`,`{TodayCheckInCount}`,`{EnterpriseAccNo}`,`Favorite-CheckIn`,`Online`);"  class="ayohaFavCard {[xindex==1 ? "isTop" : ""]}">' +
              ...
              '<div class="name">{EnterpriseName}</div>' +
              '<div class="meta">{CheckInCount}x • Last: {CheckInDateTime}</div>' +
      ...
      // itemTpl:
      // '<div class="ayohaFavCardWrap {[xindex==1 ? "isTop" : ""]}">' +
      //   '<div class="ayohaFavCardInner">' +
    
      //     '<div class="badge">❤️ Favorite</div>' +
    ...
    items: [
         {
            ...
            margin: '0 0 0 14',
            //   html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: auto;height:60px"></colgroup><thead><tr><th style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:center;vertical-align:top;word-break:normal"><div style="color:black;text-align: center;font-size:18px;width:100%;">Tarmizi Rahim</div><br><div style="color:black;text-align: center;font-size:12px;width:100%;margin:-27px 0px 0px 0px;">Ayoha Legendry Card</div><img src="resources/icons/editProfileWhite.png" width="30" height="30" alt="Company Name"></tr></thead></table>',
           html: '<div     style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:10px 0px 0px 10px"><b>🎁 Check-In Reward</b></div><br> <div style="margin:-21px 0px 0px 12px;font-size:11px;color:#6b7280;">Unlock perks via check-in at every merchant</div>'
 ...
 
{
  ...
  // ✅ penting supaya itemTpl dirender macam Touch
  useComponents: false,
                ...
                items: [
                     {
                        ...
                        // html: '<div style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:10px 0px 0px 10px"><b>🎫 Membership Card Hubs</b></div><br><div  style="color:black;text-align: left;font-size:10px;width:100%;margin:-21px 0px 0px 12px;">One hub for all merchant memberships</div>'
                         html: '<div style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:10px 0px 0px 10px"><b>🎫 Membership Card Hubs</b></div></b></div><br> <div style="margin:-21px 0px 0px 12px;font-size:11px;color:#6b7280;">One hub for all merchant memberships</div>'
...
'</div>'
 ...
 ///////////////////////////////////Membership Loyalty Program Reward////////

 {
  ...
  width: '100%',
   height: 190,
 // hidden: false,
  id:'containerDashboard_MembershipLoyaltyProgramReward',
 // margin: '0 0 0 0',
 margin: '0 0 0 0',
  // style: 'border-right:2px solid #ECF0F1;border-left:2px solid #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px solid #ECF0F1 ;background: white;border-radius: 0px 15px 15px 0px;',
  //  style: 'border-right:2px none #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px none #ECF0F1;border-top:2px none #ECF0F1 ;background: red;',
  ...
  items: [
       {
          ...
          margin: '0 0 0 14',
          //   html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: auto;height:60px"></colgroup><thead><tr><th style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:center;vertical-align:top;word-break:normal"><div style="color:black;text-align: center;font-size:18px;width:100%;">Tarmizi Rahim</div><br><div style="color:black;text-align: center;font-size:12px;width:100%;margin:-27px 0px 0px 0px;">Ayoha Legendry Card</div><img src="resources/icons/editProfileWhite.png" width="30" height="30" alt="Company Name"></tr></thead></table>',
         html: '<div     style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:10px 0px 0px 10px"><b>👑 Membership Campaigns</b></div><br> <div style="margin:-21px 0px 0px 12px;font-size:11px;color:#6b7280;">Member-only benefits. Earn and redeem rewards.</div>'
   ...
   {
    id: 'listDashboard_MembershipLoyaltyProgramReward',
   // hidden:true,
    margin: '10 0 0 14',
    xtype: 'dataview',
 // height: 290,
  ...
  // height: 0,
    ...
    width: '93%',
    itemCls: 'ayohaCampItem',
    itemTpl:
    '<div  class="ayohaCampCard">' +
      '<div class="ayohaCampIco">' +
        '<img src="{IconImg}" class="ayohaCampIcoImg"  />' +
      '</div>' +
  
      '<div class="ayohaCampMid">' +
        '<div class="ayohaCampTitle">{Title}</div>' +
        '<div class="ayohaCampSub">{countPerks_Program} available</div>' +
      '</div>' +
  
      '<div class="ayohaCampRight">' +
        '<div class="ayohaCampCountPill">{countPerks_Program}</div>' +
        '<div class="ayohaCampChev">›</div>' +
      '</div>' +
    '</div>',
    listeners: {
      // Modern biasanya ada itemtap
...

{
  ...
  width: '100%',
   height: 580,
 // hidden: false,
  id:'containerDashboard_MembershipExclusiveDeal',
 // margin: '0 0 0 0',
 margin: '0 0 0 0',
  // style: 'border-right:2px solid #ECF0F1;border-left:2px solid #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px solid #ECF0F1 ;background: white;border-radius: 0px 15px 15px 0px;',
  //  style: 'border-right:2px none #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px none #ECF0F1;border-top:2px none #ECF0F1 ;background: red;',
  ...
  items: [
       {
          ...
          margin: '0 0 0 14',
          //   html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: auto;height:60px"></colgroup><thead><tr><th style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:center;vertical-align:top;word-break:normal"><div style="color:black;text-align: center;font-size:18px;width:100%;">Tarmizi Rahim</div><br><div style="color:black;text-align: center;font-size:12px;width:100%;margin:-27px 0px 0px 0px;">Ayoha Legendry Card</div><img src="resources/icons/editProfileWhite.png" width="30" height="30" alt="Company Name"></tr></thead></table>',
         html: '<div     style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:10px 0px 0px 10px"><b>🏷️ Membership Exclusive Deal</b></div><br> <div style="margin:-21px 0px 0px 12px;font-size:11px;color:#6b7280;">Special offers reserved for members,don’t miss out.</div>'
       ...
       {
        xtype: 'dataview',
        id: 'dvMembershipExclusiveDeal',
        cls: 'ayohaDealView',
        width: '93%',
        margin: '10 0 0 14',
        height: 500, // cukup untuk card penuh
        inline: { wrap: false },
        style: "background-color: rgba(0, 0, 0, 0);",
        scrollable: { direction: 'horizontal', indicators: false },
      
        // ✅ guna store anda sendiri
        // store: Ext.getStore('StoreExclusiveDeals'),
      
        // (Demo store - boleh buang bila dah bind DB)
        // store: {
        //   fields: [
        //     'ProductName','ProductImg','DiscountText',
        //     'NormalPrice','MemberPrice',
        //     'MerchantName','MerchantLogo','MerchantLocation','DistanceKm',
        //     'Rating','ReviewCount'
        //   ],
        //   data: [{
        //     ProductName: 'Nasi Lemak Lobster Chegu',
        //     ProductImg: 'https://images.unsplash.com/photo-1550547660-d9450f859349?auto=format&fit=crop&w=1200&q=80',
        //     DiscountText: 'Jimat RM5.00',
        //     NormalPrice: 'RM 25.00',
        //     MemberPrice: 'RM 20.00',
        //     MerchantName: 'Chegu Restaurant',
        //     MerchantLogo: 'https://images.unsplash.com/photo-1529070538774-1843cb3265df?auto=format&fit=crop&w=200&q=80',
        //     MerchantLocation: 'Putrajaya',
        //     DistanceKm: '1.4',
        //     Rating: '4.8',
        //     ReviewCount: '1.2k'
        //   }]
        ...
        emptyText: '<div style="padding:14px;color:#6b7280">No deals</div>',
        ...
        itemTpl: [
          '<div class="ayohaDealCard" >',
            ...
            '<div class="dealMedia">',
              ...
              '<img class="dealImg" src="{AdvertismentMediaUrl}" />',
              //  'onerror="this.src=\\\'resources/icons/defaultMerchant.png\\\'" />',
              '<div class="dealMediaGlow"></div>',
            '</div>',
      
            '<div class="dealBody">',
              '<div class="dealTitle">{AdvertismentMediaNote}</div>',
      
              '<div class="dealMerchantRow">',
                '<img class="mLogo" src="{EnterpriseLogoPath}" />',
                //  'onerror="this.style.display=\\\'none\\\'" />',
                '<div class="mMid">',
                  '<div class="mName">{EnterpriseName}</div>',
                  '<div class="mLoc">{EnterpriseAddress}',
                    '<tpl if="DistanceKm"> • {DistanceKm}km</tpl>',
                  '</div>',
                '</div>',
                '<div class="mRate">',
                  '<span class="star">⭐</span>',
                  '<span class="val">{AverageRating}</span>',
                  '<span class="cnt">({TotalReviews})</span>',
                '</div>',
              '</div>',
      
              '<div class="dealPrices">',
                '<div class="dealNormal">',
                  '<span class="k">Normal</span>',
                  '<span class="v">RM{NormalPrice}</span>',
                '</div>',
                '<div class="dealMember">',
                  '<span class="k">Member</span>',
                  '<span class="v"><span class="memberLock">🔒</span>RM{MemberPrice}</span>',
                '</div>',
              '</div>',
      
              // CTA gunakan data-action untuk detect klik dalam itemtap
              '<div class="dealCta" data-action="buy">',
        ...
        listeners: {
          itemtap: function(view, index, target, record, e){
            // Klik CTA sahaja
            var cta = Ext.fly(e.target).up('[data-action=buy]', null, true);
            if(cta){
              // TODO: open checkout / product detail
              // contoh:
              // FloatPanel_StoreProductDetailsShow(record.get('ProductID'));
...

{
  ...
  '<div style="width:100%;height:60px;display:flex;align-items:center;justify-content:center;">' +
    '<img src="resources/icons/NeodataLogoForAyoha.png" style="width:170px;height:50px;display:block;" />' +
  '</div>'
        //   html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: auto;height:60px"></colgroup><thead><tr><th style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:center;vertical-align:top;word-break:normal"><div style="color:black;text-align: center;font-size:18px;width:100%;">Tarmizi Rahim</div><br><div style="color:black;text-align: center;font-size:12px;width:100%;margin:-27px 0px 0px 0px;">Ayoha Legendry Card</div><img src="resources/icons/editProfileWhite.png" width="30" height="30" alt="Company Name"></tr></thead></table>',
       //html: '<div     style="color:#BFBFC1;text-align: center;font-size:12px;width:100%;margin:0px 0px 0px 0px;font-weight:bold;">Ayoha Reward is one of the product brands developed in collaboration with NeoDataX.</div>'
     // html:'<img  src="resources/icons/NeodataLogoForAyoha.png" style="width:170px;height:50px;" />',
      },
    ]
},
                ...
                items: [
                     {
                        ...
                        // html: '<div  style="color:white;text-align: left;font-size:10px;width:100%;margin:0px 0px 0px 0px;">00:00:00</div>'
                         ...
                         ' 👑 Ayoha Premium Perks'+
                         '</span>'+
                         '</div><br><div style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:0px 0px 0px 0px"><b>Selected premium perks by Ayoha</b></div></div><br><div  style="color:black;text-align: left;font-size:10px;width:100%;margin:-25px 0px 0px 0px;">Dont be missed the great chances</div>'
                        ...
                        // html: '<div style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:10px 0px 0px 10px"><b>Membership Card Hubs</b></div><br><div  style="color:black;text-align: left;font-size:10px;width:100%;margin:-25px 0px 0px 0px;">Tap the card to see what’s included and how it pays back</div>'
                     },
                     {
                         xtype: 'spacer'
                     },
                ...
                items: [
                     {
                       ...
                       //  html: '<div style="color:black;text-align: left;font-size:14px;width:100%;margin:0px 0px 0px 0px"><b>Membership Loyalty Campaigns</b></div><br><div  style="color:black;text-align: left;font-size:10px;width:100%;margin:-25px 0px 0px 0px;">Member only benefits,turn your transactions into a reward</div>'
                         // html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: 70%"><col style="width:30%"></colgroup><thead><tr><th style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:right;vertical-align:top;word-break:normal" rowspan="2"><div style="margin:0px 0px 0px -15px">TARMIZI RAHIM</div><br>Lagendary Card Mortal </th><th style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:left;vertical-align:middle;word-break:normal" rowspan="2">Medal</th></tr><tr></tr></thead></table>'
                         html: '<div style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:10px 0px 0px 0px"><b>Membership Loyalty Campaigns</b></div><br><div  style="color:black;text-align: left;font-size:10px;width:100%;margin:-25px 0px 0px 0px;">Member only benefits,turn your transactions into a reward</div>'
                        },
                     {
                         xtype: 'spacer'
                     },
  ...
  
        {
            ...
            align: 'center',
            },items:[
                {
                    xtype: 'container',
                    width: '80%',
                    style: 'border:2px solid #E5E7EB;background: white;border-radius: 10px 10px 10px 10px;',
                    height:80,
                    hidden: false,
                    margin: '0 0 0 0',
  ...
  //////////////////////////////////line 3 start -NEW///////////////////////////////
  {
    ...
    items:[
        ...
        },
        {
            ...
            name:'namecontainerMyAccount_Dashboard_MembershipCheckInCardLoyaltyy',
            style: 'background-color:transparent',
            layout: {
            type: 'hbox',
            pack: 'center',
    ...
    items: [
         {
             margin: '0 0 0 14',
             //   html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: auto;height:60px"></colgroup><thead><tr><th style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:center;vertical-align:top;word-break:normal"><div style="color:black;text-align: center;font-size:18px;width:100%;">Tarmizi Rahim</div><br><div style="color:black;text-align: center;font-size:12px;width:100%;margin:-27px 0px 0px 0px;">Ayoha Legendry Card</div><img src="resources/icons/editProfileWhite.png" width="30" height="30" alt="Company Name"></tr></thead></table>',
            // html: '<div style="color:black;text-align: left;font-size:14px;width:100%;margin:0px 0px 0px 0px"><b>Ayoha Merchant Gems</b></div><br><div  style="color:black;text-align: left;font-size:10px;width:100%;margin:-25px 0px 0px 0px;">From neighbourhood stalls to hidden gems,<br> explore and enjoy more every visit</div>'
             html: '<div style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:10px 0px 0px 0px"><b>Most Top Ayoha Merchant</b></div><br><div  style="color:black;text-align: left;font-size:10px;width:100%;margin:-25px 0px 0px 0px;">From neighbourhood stalls to hidden gems,<br> explore and enjoy more every visit</div>'
             // html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: 70%"><col style="width:30%"></colgroup><thead><tr><th style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:right;vertical-align:top;word-break:normal" rowspan="2"><div style="margin:0px 0px 0px -15px">TARMIZI RAHIM</div><br>Lagendary Card Mortal </th><th style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:left;vertical-align:middle;word-break:normal" rowspan="2">Medal</th></tr><tr></tr></thead></table>'
         },
         {
             xtype: 'spacer'
                ...
                items: [
                     {
                         margin: '0 0 0 14',
                         //   html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: auto;height:60px"></colgroup><thead><tr><th style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:center;vertical-align:top;word-break:normal"><div style="color:black;text-align: center;font-size:18px;width:100%;">Tarmizi Rahim</div><br><div style="color:black;text-align: center;font-size:12px;width:100%;margin:-27px 0px 0px 0px;">Ayoha Legendry Card</div><img src="resources/icons/editProfileWhite.png" width="30" height="30" alt="Company Name"></tr></thead></table>',
                        // html: '<div style="color:black;text-align: left;font-size:14px;width:100%;margin:0px 0px 0px 0px"><b>Merchant VIP Advertisement </b></div><br><div  style="color:black;text-align: left;font-size:10px;width:100%;margin:-25px 0px 0px 0px;">From neighbourhood stalls to hidden gems,<br>enjoy more every visit</div>'
                         html: '<div style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:10px 0px 0px 0px"><b>Merchant VIP Advertisement</b></div><br><div  style="color:black;text-align: left;font-size:10px;width:100%;margin:-25px 0px 0px 0px;">Ayoha merchant with special offered for you</div>'
                         // html: '<table style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 100%" class="tg"><colgroup><col style="width: 70%"><col style="width:30%"></colgroup><thead><tr><th style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:right;vertical-align:top;word-break:normal" rowspan="2"><div style="margin:0px 0px 0px -15px">TARMIZI RAHIM</div><br>Lagendary Card Mortal </th><th style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:0px 0px;text-align:left;vertical-align:middle;word-break:normal" rowspan="2">Medal</th></tr><tr></tr></thead></table>'
                     },
                     {
                         xtype: 'spacer'
    ...
    items: [
         {
            ...
            // html: '<div style="color:black;text-align: left;font-size:14px;width:100%;"><b>Hot Seat Promotion!</b></div><br><div style="color:black;text-align: left;font-size:10px;width:100%;margin:-25px 0px 0px 0px;">Member price + bonus points,while it lasts.</div>'
             html: '<div style="color:#3A0ca3;text-align: left;font-size:18px;width:100%;margin:10px 0px 0px 0px"><b>Hot Seat Promotion!</b></div><br><div  style="color:black;text-align: left;font-size:10px;width:100%;margin:-25px 0px 0px 0px;">Member price + bonus points,while it lasts.</div>'
...
{
    layout: 'fit',
    title: 'AyohaRewards_Merchant',  
    xtype: 'AyohaMerchantReward',
},

{
    layout: 'fit',
    title: 'MembershipCard_List',  
...

                                             {
                                                 ...
                                                 items: [
                                                     ...
                                                     },
                                                     {
                                                        ...
                                                        {
                                                            xtype: 'container',
                                                            id: 'containerMyAccount_Dashboard_MenuBottom_Home',
                                                           ...
                                                           style: "background-color: transparent",
                                                            ...
                                                            items: [

                                                                 {
                                                                     ...
                                                                     height: 22,
                                                                     width: 22,
                                                                     html: '<img src="resources/icons/ayohaHome01.png" width="20" height="20" alt="Company Name">',
                                                                     //ui: 'plain',
                                                                     //handler: function () {
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            items: [

                                                                 {
                                                                     ...
                                                                     height: 22,
                                                                     width: 22,
                                                                     html: '<img src="resources/icons/Logo/icon_ayoha_gradient_diagonal.png" width="22" height="22" alt="Company Name">',
                                                                     //ui: 'plain',
                                                                     //handler: function () {
...
////////merchant reward
{
    ...
    items: [
         ...
         {
             //xtype: 'button',
             id: 'btn_MyAccount_Dashboard_MenuBottom_MerchantperkBottom',
             // badgeText: '10',
             margin: '0 0 0 0',

             height: 22,
             width: 22,
             html: '<img src="resources/icons/merchantReward03.png" width="22" height="22" alt="Company Name">',
             //ui: 'plain',
             //handler: function () {
             //    // FloatLoyaltyCardStampShow();
             //    //  NotificationIndividualPanelShow();
         ...
         {
             xtype: 'container',
             id: 'containerMyAccount_Dashboard_MenuBottom_MerchantperkTxtBottom',
             width: '100%',
             layout: {
                 type: 'vbox',
                 pack: 'center',
...

                                                     {
                                                         ...
                                                         items: [

                                                              {
                                                                  ...
                                                                  height: 20,
                                                                  width: 20,
                                                                  html: '<img src="resources/icons/MembershipCardIcon01.png" width="20" height="20" alt="Company Name">',
                                                                  //ui: 'plain',
                                                                  //handler: function () {
...
function initializeContainerSingleTapEvent() {
    ...
    containerViewElMenuBottom_MyMembershipCard.on('tap',
      ...
      //  Ext.getCmp('containerAyohaMerchantRewardBottom_Search').setHidden(true);
       ...
       // AyohaMerchantReward_Reset();
          ...
          AppState.MainDashboard.MainDashboardBottomkMenuTabTag = "MyMembershipCard";
         // FloatPanel_MembershipCardList_MyMembershipCardShow();
      }
    );
    ...
    containerViewElMenuBottom_AyohaReward.on('tap',
      function (event, node, options, eOpts) {
       ...
       // Ext.getCmp('containerAyohaMerchantRewardBottom_Search').setHidden(true);
          ...
          AppState.MainDashboard.MainDashboardBottomkMenuTabTag = "Home";
      }
    );
    ...
    containerViewElMenuBottom_MyStore.on('tap',
     ...
     AyohaRewardContestLoadActiveStore();
       ...
       AyohaRewardPointRewardRankingStore();
        ...
        AppState.MainDashboard.MainDashboardBottomkMenuTabTag = "AyohaReward";
    ...
    var containerViewnamecontainerMyAccount_Dashboard_MenuBottom_MerchantperkBottom = Ext.ComponentQuery.query('container[name=namecontainerMyAccount_Dashboard_MenuBottom_MerchantperkBottom]')[0];
...
// Hide (element still takes space)
           ...
           // Ext.getCmp('Dashboard_AyohaRewardPoint').setHtml('<div  class="example-1"  style="background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9); border-radius: 50%;border:2px solid #fac;text-align:center;margin:-30px 0px 0px 0px;height:180px;width:180px"><div style="color:white;text-align: center;font-size:48px;width:100%;margin:50px 0px 0px 0px;"><b>' + AyohaPoint + '</b></div><br><div style="color:white;text-align: center;font-size:11px;width:100%;margin:-33px 0px 0px 0px"><b>Your Ayoha Points</b></div></div>');
            ...
            if (globalPNUnread != "0") {
                UpdateNotificationUnreadBadge(globalPNUnread);
...
//           Ext.getCmp('btn_MyAccount_Dashboard_MenuBottom_Notification').setHtml(
//   '<div style="position:relative;display:inline-block;width:22px;height:22px;">' +
//     '<img src="resources/icons/Notification.png" width="22" height="22" style="display:block" alt="Notification">' +
//     '<div style="' +
//       'position:absolute;top:-6px;right:-8px;' +
//       'min-width:18px;height:18px;padding:0 5px;' +
//       'display:flex;align-items:center;justify-content:center;' +
//       'font-size:11px;font-weight:700;color:#fff;' +
//       'background:#ff2d55;border-radius:999px;' +
//       'box-shadow:0 4px 10px rgba(0,0,0,.25);' +
//       'z-index:9999;' +
//     '">' + (globalPNUnread || 0) + '</div>' +
//   '</div>'
// );
  ...
  Ext.defer(function () {
    ...
    Ext.Ajax.request({
      ...
      callback: function (options, success, response) {
        // ✅ pastikan unmask sekali je, tak kira success/fail
        Ext.Viewport.unmask();

        if (!success) {
          // optional: log untuk debug
          // console.log('eWallet API failed', response && response.status, response && response.responseText);
          return;
        }

        var data = Ext.decode((response.responseText || '').trim(), true) || {};
        ...
        // ===== SUCCESS =====
        if (data.total > 0 && data.results && data.results[0]) {
          var r = data.results[0];

          globalDashboardeWalletType = r.eWalletType;
          globalDashboardeWalletStatus = r.eWalletStatus;
          globalDashboardCreditLimitPerDay = r.CreditLimitPerDay;
          globalDashboardDebitLimitPerDay = r.DebitLimitPerDay;
          globalDashboardeWalletCurrentBalance = r.eWalletCurrentBalance;

          localStorage.setItem("DashboardeWalletCurrentBalance", r.eWalletCurrentBalance);
          localStorage.setItem("isUserHasEwalletAccount", "Y");
          localStorage.setItem("AyohaeWalletDeviceID", r.DeviceID);
          localStorage.setItem("AyohaeWalletisUsedDeviceID_Detection", r.isUsedDeviceID_Detection);
          localStorage.setItem("AyohaeWalletisUsedTAC_Code", r.isUsedTAC_Code);
          localStorage.setItem("AyohaeWalletPassCode", r.PassCode);

          globalDashboardisUserHasEwalletAccount = "Y";

          if (isFloatPanel_AyohaStore_CheckOutOpen == 'Y') {
            Ext.getCmp('htmlFloatPanel_AyohaStore_CheckOut_PaymentMethod_AyohaeWallet_CurrentBalanceAmount')
              .setHtml('<div style="width:100%;background-color: transparent;text-align:right;border: 1px none white;font-size: 30px;font-weight:bold;color:#c800ffc9;margin:0px 0px 0px 0px">RM ' + globalDashboardeWalletCurrentBalance + '</div>');
          }
          ...
          if (isFloatPanel_AyohaeWalletOpen == 'Y') {
            Ext.getCmp('htmlFloatPanel_AyohaeWalletHeader_AyohaeWalletTxt')
              .setHtml('<div id="odometer_ewallet" class="odometer" style="font-family:Arial, sans-serif;font-size:38px;font-weight:bold;float:left;margin:-7px 0px 0px 0px;background-color:transparent;color:white;padding:0px 25px;">' + globalDashboardeWalletCurrentBalance + '</div>');
            FloatPanel_AyohaStore_AyohaPointCollectedAnim_startCounter();
          }

          Ext.getCmp('htmlMyAccount_Dashboard_TitleHeaderTxtAyohaEwallet')
            .setHtml(
              '<div onclick="FloatPanel_AyohaeWalletShow()" style="width:100%;background-color: transparent;text-align:center;border: 1px none white;font-size: 12px;font-weight:bold;color:black;margin:0px 0px 0px 0px">RM ' + globalDashboardeWalletCurrentBalance + '</div>' +
              '<br><div onclick="FloatPanel_AyohaeWalletShow()" style="width:100%;background-color: transparent;text-align:center;border: 1px none white;font-size: 10px;font-weight:normal;color:black;margin:-25px 0px 0px 0px">TOP UP</div>'
            );
          ...
          if (isFloatPanel_AyohaStore_CheckOutOpen == 'Y') {
            Ext.getCmp('htmlFloatPanel_AyohaStore_CheckOut_PaymentMethod_AyohaeWallet_CurrentBalanceAmount')
              .setHtml('<div style="width:100%;background-color: transparent;text-align:right;border: 1px none white;font-size: 30px;font-weight:bold;color:#c800ffc9;margin:0px 0px 0px 0px">RM 00.00</div>');
          }

          Ext.getCmp('htmlMyAccount_Dashboard_TitleHeaderTxtAyohaEwallet')
            .setHtml(
              '<div style="width:100%;background-color: transparent;text-align:center;border: 1px none white;font-size: 12px;font-weight:bold;color:black;margin:0px 0px 0px 0px">RM 00.00</div>' +
              '<br><div style="width:100%;background-color: transparent;text-align:center;border: 1px none white;font-size: 10px;font-weight:normal;color:black;margin:-25px 0px 0px 0px">TOP UP</div>'
            );
        }
      }
    });
...
function loadAdvertisementloadPremiumAdvertismentORI() {
        ...
        callback: function (records, operation, success) {
            if (success && records.length > 0) {
                ...
                for (i = 0; i < count; i++) {
                    ...
                    if (MediaType == "Image") {
                        carouselDasboardPremiumAdvertisement.add({ xtype: 'image', src: AdvertismentMediaUrl, height: '95%', width: '100%', mode: 'image', margin: '-10 0 0 0' });
                       // myCarousel.add({ xtype: 'pinchzoomimage', src: AdvertismentMediaUrl, height: 670, width: '100%', mode: 'image' });
                    }
                    //margin: '-10 0 0 0'
                    if (MediaType == "Video") {
                        carouselDasboardPremiumAdvertisement.add({ xtype: 'video', src: AdvertismentMediaUrl, height:'95%', width: '100%', mode: 'video', posterUrl: 'resources/icons/videoPurple.png', loop: true, enableControls: true, margin: '7 0 0 0' });
  ...
  Ext.defer(function () {
    ...
    Ext.Ajax.request({
      ...
      callback: function (options, success, response) {
        ...
        if (!success) {
          // optional debug:
          // console.log('CalculateRating failed', response && response.status, response && response.responseText);
          return;
        }
        ...
        if (!(data.total > 0 && data.results && data.results[0])) {
          // Tiada data rating
          updateDashboardRatingUI(0, 0);
          return;
        }

        var r = data.results[0];

        // Kekalkan assignment global macam asal (kalau code lain guna)
        FiveStar      = r.FiveStar;
        FourStar      = r.FourStar;
        ...
        var totalVoter = parseFloat(r.TotalVoter) || 0;

        // ikut formula asal kau
        var sumVote =
          (parseFloat(r.VoteFiveStar)  || 0) +
          (parseFloat(r.VoteFourStar)  || 0) +
          (parseFloat(r.VoteThreeStar) || 0) +
          (parseFloat(r.VoteTwoStar)   || 0) +
          (parseFloat(r.VoteOneStar)   || 0);

        var avg = (totalVoter > 0) ? (sumVote / totalVoter) : 0;

        // simpan global (ikut pattern asal)
        globalFloatPanelMerchantDetailPage_CountReviewer = totalVoter;
        globalFloatPanelMerchantDetailPage_CountStar     = (Math.round(avg * 10) / 10).toFixed(1);

        updateDashboardRatingUI(avg, totalVoter);
      }
    });
...
function updateDashboardRatingUI(avg, totalVoter) {
  var rating = isFinite(avg) ? avg : 0;
  var rating1dp = Math.round(rating * 10) / 10; // 1 decimal

  // rating text
  setCmpHtml(
    'htmlDashbord_ReviewAndRateCount_PremiumAdvertisement',
    '<div onclick="FloatPanelMerchantDetailPage_OpenMerchantReview();" ' +
      'style="color:white;text-align:center;font-size:16px;width:100%;font-weight:bold;margin:0;">' +
      rating1dp.toFixed(1) +
    '</div>'
  );
  ...
  // total reviews text
  setCmpHtml(
    'htmlDashbord_ReviewByCount_PremiumAdvertisement',
    '<div onclick="FloatPanelMerchantDetailPage_OpenMerchantReview();" ' +
      'style="width:100%;text-align:right;background-color:transparent;font-family:Arial,sans-serif;font-size:8px;color:white;font-weight:bold;overflow:hidden;">' +
      '<img src="resources/icons/myaccountwhite01.png" alt="Image" style="width:7px;height:7px;">&nbsp;' +
      (totalVoter || 0) + ' Reviews' +
    '</div>'
  );

  // stars
  setDashboardStars(rating1dp);
}

function setDashboardStars(rating) {
  for (var i = 1; i <= 5; i++) {
    var frac = rating - (i - 1);     // contoh star ke-3: rating - 2
    var icon = pickStarIcon(frac);   // pilih icon ikut fraction

    setCmpHtml(
      'htmlDashbord_Star' + i,
      '<div onclick="FloatPanelMerchantDetailPage_OpenMerchantReview();">' +
        '<img src="resources/icons/' + icon + '" width="9" height="9" alt="Star">' +
      '</div>'
    );
  }
}

// Mapping icon ikut pecahan star
function pickStarIcon(frac) {
  if (frac >= 0.95) return 'star.png';
  if (frac >= 0.85) return 'StarpointNine.png';
  if (frac >= 0.65) return 'StarpointSeven.png';
  if (frac >= 0.45) return 'StarpointFive.png';
  if (frac >= 0.25) return 'StarpointThree.png';
  return 'reviewstarunrate.png';
}

function setCmpHtml(id, html) {
  var cmp = Ext.getCmp(id);
  if (cmp && cmp.setHtml) cmp.setHtml(html);
}
...
function Dashboard_LoadLastCheckIn(){
    ...
    globalFloatPanelMerchantDetailPage_EnterpriseName =record.get('EnterpriseName');
    globalFloatPanelMerchantDetailPage_EnterpriseTagLine =record.get('EnterpriseTagLine');
    globalFloatPanel_MerchantDetailPage_EnterpriseFacebook = record.get('EnterpriseFacebook');
    globalFloatPanel_MerchantDetailPage_EnterpriseWebsite = record.get('EnterpriseWebsite');
    globalFloatPanel_MerchantDetailPage_EnterpriseInstagram = record.get('EnterpriseInstagram');
    globalFloatPanel_MerchantDetailPage_EnterpriseTikTok = record.get('EnterpriseTwiter');
    globalFloatPanelMerchantDetailPage_EnterpriseCoordinate = record.get('EnterpriseCoordinate');
    globalFloatPanelMerchantDetailPage_BusinessMode = record.get('BusinessMode');
    globalFloatPanelMerchantDetailPage_WhatsAppNo =record.get('PICContactNo');
    globalFloatPanelMerchantDetailPage_NamaJalan=record.get('NamaJalan');
    globalFloatPanelMerchantDetailPage_Postkod=record.get('Postkod');
    globalFloatPanelMerchantDetailPage_Bandar=record.get('Bandar');
...
Ext.getCmp('htmlMyAccount_Dashboard_MemberStatus_MerchantCheckin_Member').setHidden(false);
Ext.getCmp('htmlMyAccount_Dashboard_MemberStatus_MerchantCheckin_NonMember').setHidden(true);
...
Ext.getCmp('containerDashboardAyohaRewardMainContent').setStyle(ayohaThemeColor_Hero());
 Ext.getCmp('containerCheckInRewardProgress_Inner').setMargin('-510px 0px 0px 0px');
    ...
    Ext.getCmp('htmlMyAccount_Dashboard_MemberStatus_MerchantCheckin_Member').setHidden(true);
    Ext.getCmp('htmlMyAccount_Dashboard_MemberStatus_MerchantCheckin_NonMember').setHidden(false);
...
Ext.getCmp('containerMyAccount_DashboardHaiUser').setHidden(true);
 ...
 Ext.getCmp('containerDashboardAyohaRewardMainContent').setHeight(800);
Ext.getCmp('containerDashboardAyohaRewardMainContent').setStyle(ayohaThemeColor_Hero());
 Ext.getCmp('containerCheckInRewardProgress_Inner').setMargin('-510px 0px 0px 0px');
               ...
               AyohaSetProgress('keepEarningCard', CheckInCount, 3);
        ...
        //         Ext.getCmp('containerDashboard_LastCheckInTimeStamp').setHidden(false);
               ...
               // Ext.getCmp('btnDashboard_CheckIn').setHidden(false);                
                ...
                elLogo = document.getElementById('ayohaCardLogo');
                elName = document.getElementById('ayohaCardName');
                elTag  = document.getElementById('ayohaCardTagline');
                elStat = document.getElementById('ayohaCardStatusSpan');
                    ...
                    Ext.getCmp('html_DashboardCheckInRewardProgress_OverMaxReached').setHidden(true); 
                    Ext.getCmp('html_DashboardCheckInRewardProgress').setHidden(false); 
                   
                }
                if(CheckInCount ==3){
                    elLogo = document.getElementById('ayohaCardLogo_MaxReached');
                    elName = document.getElementById('ayohaCardName_MaxReached');
                    elTag  = document.getElementById('ayohaCardTagline_MaxReached');
                    elStat = document.getElementById('ayohaCardStatusSpan_MaxReached');
                    Ext.getCmp('containerCheckInRewardProgress').setHidden(false); 
                ...
                if(CheckInCount > 3){
                    elLogo = document.getElementById('ayohaCardLogo_OverMaxReached');
                    elName = document.getElementById('ayohaCardName_OverMaxReached');
                    elTag  = document.getElementById('ayohaCardTagline_OverMaxReached');
                    elStat = document.getElementById('ayohaCardStatusSpan_OverMaxReached');
                    Ext.getCmp('containerCheckInRewardProgress').setHidden(false); 
                    Ext.getCmp('html_DashboardCheckInRewardProgressMaxReached').setHidden(true); 
                    Ext.getCmp('html_DashboardCheckInRewardProgress_OverMaxReached').setHidden(false);                     
                    Ext.getCmp('html_DashboardCheckInRewardProgress').setHidden(true);
                ...
                if (elLogo && elName) {
                    // Kalau wujud, baru update
                    elLogo.src = record.get('EnterpriseLogoPath');
                    elName.innerText =  record.get('EnterpriseName');
                    elTag.innerText = '📍'+ record.get('Bandar')+'-'+record.get('Negeri')+' • 🍽️ '+record.get('JenisPerniagaan');
                    elStat.innerText =  record.get('CheckInCountStr')+'-'+RelativeCheckInTime
                } else {
                    console.log("Error: HTML Card belum wujud lagi.");
                }
            
                SetOverMaxCount(CheckInCount);
              ...
              //  Ext.getCmp('containerCheckInRewardspacer02').setHidden(true); 
               ...
               // Ext.getCmp('DashboardMain_EnterprisesLoadCheckInEmptyID').setHidden(true); 
                ...
                //Ext.getCmp('containerDashboard_BuskartApp_htmlDashboard_NotYetCheckInTxt').setHidden(true); 
...
Ext.getCmp('containerMyAccount_DashboardHeader').setHidden(true);
Ext.getCmp('containerMyAccount_DashboardHeader_MerchantCheckIn').setHidden(false);
...
//Ext.getCmp('Dashboard_Carousel_CheckIn').setHidden(false); 
//Ext.getCmp('Dashboard_Carousel_CheckIn').setHeight(280); 
...
//14/1/2026
            //   Ext.getCmp('Dashboard_Carousel_takCheckIn').setHidden(false); 
            //   Ext.getCmp('Dashboard_Carousel_takCheckIn').setHeight(205);
            ...
            //   Ext.getCmp('Dashboard_Carousel_CheckIn').setHeight(0); 
              ...
              Ext.getCmp('containerCheckInMerchantPage').setHidden(true);
              Ext.getCmp('containerDashboard_PerksYouCanEnjoyHere').setHidden(true);
              Ext.getCmp('containerDashboard_MembershipCard_CheckIn').setHidden(true);
              Ext.getCmp('containerDashboard_RecentVisitor_CheckIn').setHidden(true);
...
Ext.getCmp('containerMyAccount_DashboardHeader').setHidden(false);
Ext.getCmp('containerMyAccount_DashboardHeader_MerchantCheckIn').setHidden(true);
...
Ext.getCmp('containerMyAccount_DashboardHaiUser').setHidden(false);
  ...
  Ext.getCmp('htmlMyAccount_Dashboard_MemberStatus_MerchantCheckin_NonMember').setHidden(false);
             ...
             // Ext.getCmp('containerDashboard_RecentlyCheckInTitle').setHidden(false); 
              ...
              Ext.getCmp('containerDashboard_CheckOut').setHidden(true); 
             ...
             //   Ext.getCmp('labelDashboard_LastCheckInTimeStamp').setHidden(true);
              ...
              //  Ext.getCmp('DashboardMain_EnterprisesLoadLastCheckInStoreID').setHeight(110);
               // Ext.getCmp('DashboardMain_EnterprisesLoadLastCheckInStoreID').setStyle('background-color:rgba(255, 255, 255, 10);border-radius: 10px 10px 0px 0px;');
               //Ext.getCmp('containerDashboard_BuskartApp_htmlDashboard_NotYetCheckInTxt').setHidden(false); 
              // Ext.getCmp('containerDashboard_imgDashboard_succesMaskotCheckIn_htmlDashboard_LastCheckInTxt').setHidden(true); 
              //  Ext.getCmp('DashboardMain_EnterprisesLoadLastCheckInStoreID').setStyle('background-color:rgba(250, 245, 255, 1);border-radius: 10px 10px 0px 0px;');
           


    //14/1/2026
              // Ext.getCmp('btnDashboard_CheckIn').setHidden(true);
              CoreFunction_DashboardLoadEnterprisesFavorite();
...
function UpdateNotificationUnreadBadge(globalPNUnread){
  var n = parseInt(globalPNUnread || 0, 10);
  var el = document.getElementById('ayohaNotifBadgeUnread');
  if (!el) return;

  if (n > 0){
    el.style.display = 'block';
    el.innerHTML = (n > 99) ? '99+' : String(n);
  } else {
...
function Ayoha_ToggleFavoriteMerchant() {
  var el = document.getElementById('btnAyohaFavorite_MaxReached');
  if (!el) return;
...
function Ayoha_ToggleFavoriteMerchant() {
  var btn = document.getElementById('btnAyohaFavorite_KeepEarning');
  if (!btn) return;

  var svg = btn.querySelector('svg');
  if (!svg) return;

  var currentFill = svg.style.fill || 'none';

  if (currentFill === 'none' || currentFill === '') {
      svg.style.fill = '#f5b3ef';
