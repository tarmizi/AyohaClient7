...
Ext.define('BuskartApp.store.AyohaeWalletTransaction.AyohaeWalletTransactionLoadByeWalletAccNoDebitCreditStore', {
});

var _DataStore_AyohaeWalletTransactionLoadByeWalletAccNoDebitCreditStore = Ext.create('Ext.data.Store', {

    model: 'BuskartApp.model.AyohaeWalletTransaction.AyohaeWalletTransactionModel',
    id: '_AyohaeWalletTransactionLoadByeWalletAccNoDebitCreditStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaeWalletTransaction/AyohaeWalletTransactionLoadByeWalletAccNoDebitCredit',
        actionMethods: {
            read: 'GET'
        },
        reader: {
    ...
    grouper: {
        groupFn: function (record) {
            ...
            return '<div style="color:white;text-align: right;font-size:15px;width:98%;margin:0px 0px 0px 10px;">' + record.get('CreatedDate_MonthYear') + '</div>'
        },
        sortProperty: 'Month'
    }
    //autoLoad: true
