...
Ext.define('BuskartApp.store.AyohaeWalletTransaction.AyohaeWalletTransactionLoadByeWalletAccNoFilterTypeStore', {
});

var _DataStore_AyohaeWalletTransactionLoadByeWalletAccNoFilterTypeStore = Ext.create('Ext.data.Store', {

    model: 'BuskartApp.model.AyohaeWalletTransaction.AyohaeWalletTransactionModel',
    id: '_AyohaeWalletTransactionLoadByeWalletAccNoFilterTypeStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaeWalletTransaction/AyohaeWalletTransactionLoadByeWalletAccNoFilterType',
        actionMethods: {
            read: 'GET'
        },
        reader: {
...
var _DataStore_AyohaeWalletTransactionLoadByeWalletAccNoFilterTypeAllTransactionStore = Ext.create('Ext.data.Store', {

    model: 'BuskartApp.model.AyohaeWalletTransaction.AyohaeWalletAllTransactionModel',
    id: 'AyohaeWalletTransactionLoadByeWalletAccNoFilterTypeAllTransactionStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaeWalletTransaction/AyohaeWalletTransactionLoadByeWalletAccNoFilterTypeAllTransaction',
        actionMethods: {
            read: 'POST'
        },
        reader: {
