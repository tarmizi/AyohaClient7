Ext.define('BuskartApp.store.LoyaltyStamp.LoyaltyStampLoadBySubscriberAccNoAndMembershipCardCodeStore', {
    extend: 'Ext.data.Store',
    //  alias: 'store.ResponderAlertGetByAcc',
    config: {
        model: 'BuskartApp.model.LoyaltyStamp.LoyaltyStampModel',
        autoLoad: false,
        ...
        proxy: {
            ...
            url: GetAPIurl() + '/LoyaltyStamp/LoyaltyStampLoadBySubscriberAccNoAndMembershipCardCode',
            reader: {
                type: 'json',
