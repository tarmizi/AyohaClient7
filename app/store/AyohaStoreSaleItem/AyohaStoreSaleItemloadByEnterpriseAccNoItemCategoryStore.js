...
var _DataStore_AyohaStoreSaleItemloadByEnterpriseAccNoItemCategoryStore = Ext.create('Ext.data.Store', {
    ...
    grouper: {
        groupFn: function (record) {
            ...
            return '<div style="color:white;text-align: left;font-size:15px;width:100%;margin:0px 0px 0px 10px;">' + record.get('ProductCategoryName') + '</div>'
        },
        sortProperty: 'ProductCategoryName'
    }
