...
Ext.define('BuskartApp.store.AyohaMerchantInfoMembershipLoyaltyProgram.AyohaMerchantInfoMembershipLoyaltyProgramStore', {
});

var _DataStore_AyohaMerchantInfoMembershipLoyaltyProgramStore = Ext.create('Ext.data.Store', {

    model: 'BuskartApp.model.AyohaMerchantInfoMembershipLoyaltyProgram.AyohaMerchantInfoMembershipLoyaltyProgramModel',
    id: '_AyohaMerchantInfoMembershipLoyaltyProgramStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaMerchantInfo_MembershipLoyaltyProgram/AyohaMerchantInfoMembershipLoyaltyProgram',
        actionMethods: {
            read: 'GET'
        },
        reader: {
