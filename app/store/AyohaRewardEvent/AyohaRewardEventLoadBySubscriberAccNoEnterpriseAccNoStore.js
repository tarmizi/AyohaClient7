...
Ext.define('BuskartApp.store.AyohaRewardEvent.AyohaRewardEventLoadBySubscriberAccNoEnterpriseAccNoStore', {
});

var _DataStore_AyohaRewardEventLoadBySubscriberAccNoEnterpriseAccNoStore = Ext.create('Ext.data.Store', {

    model: 'BuskartApp.model.AyohaRewardEvent.AyohaRewardEventModel',
    id: '_AyohaRewardEventLoadBySubscriberAccNoEnterpriseAccNoStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaRewardEvent/AyohaRewardEventLoadBySubscriberAccNoEnterpriseAccNo',
        actionMethods: {
            read: 'GET'
        },
        reader: {
