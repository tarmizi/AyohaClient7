...
Ext.define('BuskartApp.store.AyohaRewardVoucherEntitledUser.AyohaRewardVoucherEntitledUserLoadBySubscriberAccNoAyohaStoreVoucherHistoryStore', {
});
...
var _DataStore_AyohaRewardVoucherEntitledUserLoadBySubscriberAccNoAyohaStoreVoucherHistoryStore = Ext.create('Ext.data.Store', {
    ...
    grouper: {
        groupFn: function (record) {
            ...
            return  record.get('Voucher_EnterpriseName')
        },
...
var _DataStore_AyohaRewardVoucher_EntitledUser_LoadBySubscriberAccNo_MembershipCardStore = Ext.create('Ext.data.Store', {

    model: 'BuskartApp.model.AyohaRewardVoucherEntitledUser.AyohaRewardVoucherEntitledUser_VoucherHistoryModel',
    id: '_AyohaRewardVoucher_EntitledUser_LoadBySubscriberAccNo_MembershipCardStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaRewardVoucher_EntitledUser/AyohaRewardVoucher_EntitledUser_LoadBySubscriberAccNo_MembershipCard',
        actionMethods: {
            read: 'GET'
        },
        reader: {
