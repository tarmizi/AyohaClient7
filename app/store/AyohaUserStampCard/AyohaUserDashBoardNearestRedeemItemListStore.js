Ext.define('BuskartApp.store.AyohaUserStampCard.AyohaUserDashBoardNearestRedeemItemListStore', {
    ...
    config: {
        ...
        proxy: {
            ...
            url: GetAPIurl() + '/AyohaUserStampCard/AyohaUserDashBoardNearestRedeemItemList',
            reader: {
                type: 'json',
...
var _DataStore_AyohaUserDashBoardNearestRedeemItemListStore = Ext.create('Ext.data.Store', {

    model: 'BuskartApp.model.AyohaUserStampCard.AyohaUserStampCardModel',
    id: '_AyohaUserDashBoardNearestRedeemItemListStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaUserStampCard/AyohaUserDashBoardNearestRedeemItemList',
        actionMethods: {
    ...
    grouper: {
        groupFn: function (record) {
            ...
            return '<div style="color:white;text-align: left;font-size:15px;width:100%;margin:0px 0px 0px 10px;">' + record.get('ModifiedCampaignType') + '</div>'
        },
        sortProperty: 'ModifiedCampaignType'
    }
